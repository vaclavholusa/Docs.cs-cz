...
ms.locfileid: "41755726"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="03b14-102">Webové formuláře ASP.NET a Ajax 4</span><span class="sxs-lookup"><span data-stu-id="03b14-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="03b14-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="03b14-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="03b14-104">Poznámka: Globalizace skriptů, jako třeba fr-FR.js, najdete v následující složce:</span><span class="sxs-lookup"><span data-stu-id="03b14-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
