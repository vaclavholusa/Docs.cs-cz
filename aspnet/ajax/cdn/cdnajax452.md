...
---
<a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="0a4b3-102">Webové formuláře ASP.NET a Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="0a4b3-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>
====================
<span data-ttu-id="0a4b3-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="0a4b3-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="0a4b3-104">Poznámka: Globalizace skriptů, jako třeba fr-FR.js, najdete v následující složce:</span><span class="sxs-lookup"><span data-stu-id="0a4b3-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
