...
title: Webové formuláře ASP.NET a Ajax 4.5.2 | Microsoft Docs
...
====================
<span data-ttu-id="3b953-103">Následující soubory jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="3b953-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="3b953-104">Poznámka: Globalizace skripty, jako je například fr-FR.js, naleznete v následující složce:</span><span class="sxs-lookup"><span data-stu-id="3b953-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
