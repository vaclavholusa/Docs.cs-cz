...
ms.locfileid: "30071431"
---
<a name="jquery-datatables-1104"></a><span data-ttu-id="fbb88-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="fbb88-102">jQuery DataTables 1.10.4</span></span>
====================
<span data-ttu-id="fbb88-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="fbb88-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
