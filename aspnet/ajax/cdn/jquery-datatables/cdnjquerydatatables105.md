...
ms.locfileid: "30078085"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="ba3e3-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="ba3e3-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="ba3e3-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="ba3e3-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
