...
ms.locfileid: "30078306"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="4d81c-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="4d81c-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="4d81c-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="4d81c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
