...
ms.locfileid: "30071230"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="47d5f-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="47d5f-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="47d5f-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="47d5f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
