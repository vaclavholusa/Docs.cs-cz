...
ms.locfileid: "30071353"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="120b7-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="120b7-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="120b7-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="120b7-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
