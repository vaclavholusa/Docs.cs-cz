...
title: jQuery DataTables 1.9.3 | Dokumentace Microsoftu
...
ms.locfileid: "37365185"
---
<a name="jquery-datatables-193"></a><span data-ttu-id="42478-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="42478-102">jQuery DataTables 1.9.3</span></span>
====================
<span data-ttu-id="42478-103">Následující soubory pro architekturu jQuery DataTables moduly plug-in jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="42478-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
