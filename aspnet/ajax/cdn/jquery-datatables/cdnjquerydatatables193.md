...
ms.locfileid: "30074541"
---
<a name="jquery-datatables-193"></a><span data-ttu-id="aa0c7-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="aa0c7-102">jQuery DataTables 1.9.3</span></span>
====================
<span data-ttu-id="aa0c7-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="aa0c7-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
