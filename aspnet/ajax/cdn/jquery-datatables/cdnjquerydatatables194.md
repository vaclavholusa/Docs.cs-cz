...
ms.locfileid: "30071191"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="4396d-102">jQuery DataTables otázku 1.9.4</span><span class="sxs-lookup"><span data-stu-id="4396d-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="4396d-103">Následující soubory pro architekturu jQuery DataTables modulů plug-in jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="4396d-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
