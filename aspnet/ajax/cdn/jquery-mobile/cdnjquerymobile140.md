...
ms.locfileid: "37801628"
---
<a name="jquery-mobile-140-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="505d5-102">jQuery Mobile 1.4.0 ve službě Microsoft Ajax CDN</span><span class="sxs-lookup"><span data-stu-id="505d5-102">jQuery Mobile 1.4.0 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="505d5-103">Knihovna jQuery Mobile 1.4.0 zahrnuje následující soubory:</span><span class="sxs-lookup"><span data-stu-id="505d5-103">The jQuery Mobile 1.4.0 library includes the following files:</span></span>
