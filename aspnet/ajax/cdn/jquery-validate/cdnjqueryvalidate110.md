...
ms.locfileid: "30071954"
---
<a name="jquery-validation-1100"></a><span data-ttu-id="5106c-102">jQuery ověření 1.10.0</span><span class="sxs-lookup"><span data-stu-id="5106c-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="5106c-103">Následující soubory jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="5106c-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="5106c-104">Lokalizace soubory v https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages \_## .js kde ## je kód umístění.</span><span class="sxs-lookup"><span data-stu-id="5106c-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
