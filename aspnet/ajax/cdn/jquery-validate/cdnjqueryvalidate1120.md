...
---
<a name="jquery-validation-1120"></a><span data-ttu-id="98a57-102">jQuery 1.12.0 ověření</span><span class="sxs-lookup"><span data-stu-id="98a57-102">jQuery Validation 1.12.0</span></span>
====================
<span data-ttu-id="98a57-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="98a57-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="98a57-104">Lokalizace souborů na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js kde ## je lokalizace kódu.</span><span class="sxs-lookup"><span data-stu-id="98a57-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js where ## is the loc code.</span></span>
