...
ms.locfileid: "41753450"
---
<a name="jquery-validation-1140"></a><span data-ttu-id="c18c2-102">Ověření 1.14.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="c18c2-102">jQuery Validation 1.14.0</span></span>
====================
<span data-ttu-id="c18c2-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="c18c2-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c18c2-104">Lokalizace souborů na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js kde ## je lokalizace kódu.</span><span class="sxs-lookup"><span data-stu-id="c18c2-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
