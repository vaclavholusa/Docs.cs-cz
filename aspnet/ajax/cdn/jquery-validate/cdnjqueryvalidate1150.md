...
====================
<span data-ttu-id="78e27-103">Následující soubory jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="78e27-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="78e27-104">Lokalizace soubory v https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages \_## .js kde ## je kód umístění.</span><span class="sxs-lookup"><span data-stu-id="78e27-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
