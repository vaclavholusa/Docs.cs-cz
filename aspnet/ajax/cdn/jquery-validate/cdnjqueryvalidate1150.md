...
ms.locfileid: "41754887"
---
<a name="jquery-validation-1150"></a><span data-ttu-id="28408-102">Ověření 1.15.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="28408-102">jQuery Validation 1.15.0</span></span>
====================
<span data-ttu-id="28408-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="28408-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="28408-104">Lokalizace souborů na https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js kde ## je lokalizace kódu.</span><span class="sxs-lookup"><span data-stu-id="28408-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
