...
ms.locfileid: "30070508"
---
<a name="jquery-validation-1151"></a><span data-ttu-id="19d5c-102">jQuery ověření 1.15.1</span><span class="sxs-lookup"><span data-stu-id="19d5c-102">jQuery Validation 1.15.1</span></span>
====================
<span data-ttu-id="19d5c-103">Následující soubory jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="19d5c-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="19d5c-104">Lokalizace soubory v https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages \_## .js kde ## je kód umístění.</span><span class="sxs-lookup"><span data-stu-id="19d5c-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js where ## is the loc code.</span></span>
