...
ms.locfileid: "37402077"
---
<a name="jquery-validate-16"></a><span data-ttu-id="fdd52-102">jQuery ověřit 1.6</span><span class="sxs-lookup"><span data-stu-id="fdd52-102">jQuery Validate 1.6</span></span>
====================
<span data-ttu-id="fdd52-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="fdd52-103">The following files are hosted on the CDN:</span></span>
