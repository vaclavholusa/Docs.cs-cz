...
ms.locfileid: "37836707"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="b8018-102">jQuery.Validate verze 1.8</span><span class="sxs-lookup"><span data-stu-id="b8018-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="b8018-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="b8018-103">The following files are hosted on the CDN:</span></span>
