...
ms.locfileid: "37398255"
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="e6f97-102">jQuery.Validate verze 1.8.1</span><span class="sxs-lookup"><span data-stu-id="e6f97-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="e6f97-103">Následující soubory jsou hostované v síti CDN:</span><span class="sxs-lookup"><span data-stu-id="e6f97-103">The following files are hosted on the CDN:</span></span>
