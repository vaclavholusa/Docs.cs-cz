...
ms.locfileid: "30070872"
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="c478a-102">verze jQuery.Validate 1.9</span><span class="sxs-lookup"><span data-stu-id="c478a-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="c478a-103">Následující soubory jsou hostované na CDN:</span><span class="sxs-lookup"><span data-stu-id="c478a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c478a-104">Lokalizace soubory v https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages \_## .js kde ## je kód umístění.</span><span class="sxs-lookup"><span data-stu-id="c478a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
