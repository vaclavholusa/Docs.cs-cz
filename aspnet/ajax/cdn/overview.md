...
====================
> [!WARNING]
> Výrobní aplikace nesmí být pevný závislý na prostředky CDN. Aplikace by měla testování pro prostředek CDN odkazuje a použít záložní asset, když není k dispozici CDN. 
>
> Microsoft Ajax CDN nemá žádné SLA vedle pomocí Azure CDN.
>
> Použití [potíže Githubu](https://github.com/aspnet/Docs/issues/5832) k hlášení problémů s Microsoft Ajax CDN.
...
#### <a name="jquery-version-331"></a>verze jQuery 3.3.1
