...
---
<a name="building-real-world-cloud-apps-with-azure"></a>Vytváření skutečných cloudových aplikací s Azure
====================
> Vytváření skutečných cloudových aplikací s Azure


- [Úvod](introduction.md)
- [Automatizovat vše](automate-everything.md)
- [Správa zdrojového kódu](source-control.md)
- [Průběžnou integraci a doručení](continuous-integration-and-continuous-delivery.md)
- [Osvědčené postupy pro vývoj pro web](web-development-best-practices.md)
...
- [Vzor fronty způsob práce](queue-centric-work-pattern.md)
- [Další vzory a pokyny](more-patterns-and-guidance.md)
