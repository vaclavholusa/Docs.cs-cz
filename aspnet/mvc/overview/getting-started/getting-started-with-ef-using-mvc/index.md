...
====================
> Základní informace o používání Entity Framework 6 pro zobrazení a úpravy dat v aplikaci ASP.NET MVC 5.
...
- [Odolnost připojení a příkaz zachycením](connection-resiliency-and-command-interception-with-the-entity-framework-in-an-asp-net-mvc-application.md)
