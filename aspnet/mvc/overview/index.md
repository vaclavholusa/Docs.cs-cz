...
---
<a name="aspnet-mvc-guidance"></a>Pokyny pro rozhraní ASP.NET MVC
====================
- [Začínáme](getting-started/index.md)
- [Uživatelské rozhraní, rozložení a motivů](views/index.md)
- [Zabezpečení, ověřování a autorizace](security/index.md)
- [Nasazení](deployment/index.md)
- [Výkon](performance/index.md)
- [Mezinárodní prostředí a pokročilá témata](advanced/index.md)
