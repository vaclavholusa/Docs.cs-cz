...
**Obrázek 02**: dialogové okno pro vytvoření projektu testů jednotek ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image4.png))
...
**Obrázek 03**: okno Průzkumníka řešení ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image6.png))
...
**Obrázek 05**: návrháře tabulky databázi ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image10.png))
...
**Obrázek 06**: dialogové okno Přidat nové položky ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image12.png))
...
**Obrázek 07**: Výběr obsahu modelu ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image14.png))
...
**Obrázek 10**: Třída Contact ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image20.png))
...
**Obrázek 11**: Přidání kontroler Home ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image22.png))
...
**Obrázek 13**: dialogové okno pro přidání zobrazení ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image26.png))
...
**Obrázek 15**: Index zobrazení ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image30.png))
...
**Obrázek 17**: nezobrazí stránka Rozbalit ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-1-create-the-application-cs/_static/image34.png))
