...
[Stáhněte si kód](iteration-1-create-the-application-vb/_static/contactmanager_1_vb1.zip)
...
**Obrázek 01**: dialogové okno Nový projekt ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image2.png))
...
**Obrázek 02**: dialogové okno Vytvoření projektu testování částí ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image4.png))
...
**Obrázek 03**: okno Průzkumníku řešení ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image6.png))
...
**Obrázek 04**: vytvoření nové databáze Microsoft SQL Server Express ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image8.png))
...
**Obrázek 05**: Návrhář tabulky databáze ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image10.png))
...
**Obrázek 06**: dialogové okno Přidat novou položku ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image12.png))
...
**Obrázek 07**: Zvolte obsah modelu ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image14.png))
...
**Obrázek 08**: Vybrat datové připojení ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image16.png))
...
**Obrázek 09**: Zvolte si databázové objekty ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image18.png))
...
**Obrázek 10**: vyhodnocení kontaktu ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image20.png))
...
**Obrázek 11**: přidání řadiče Home ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image22.png))
...
**Obrázek 12**: Přidání zobrazení indexu ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image24.png))


V **přidat zobrazení** dialogové okno, zaškrtněte políčko s názvem bez přípony **vytvořit zobrazení silného typu**. Vyberte třídu data zobrazení ContactManager.Contact a zobrazení seznamu obsahu. Zobrazení, který zobrazí seznam záznamů, obraťte se na těchto možností generuje.
...
**Obrázek 13**: Přidat zobrazení dialogu ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image26.png))
...
**Obrázek 14**: povolení ladění ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image28.png))
...
**Obrázek 15**: Zobrazení indexu ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image30.png))
...
**Výpis 4 - Controllers\HomeController.vb (s vytvořit metody)**
...
**Obrázek 16**: Přidání zobrazení pro vytváření ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image32.png))


V **přidat zobrazení** dialogovém okně, vyberte **ContactManager.Contact** třídy a **vytvořit** možnost pro zobrazení obsahu (viz obrázek 17). Když kliknete **přidat** tlačítko, vytvořit zobrazení je generován automaticky.
...
**Obrázek 17**: zobrazuje stránku Rozbalit ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image34.png))
...
**Obrázek 18**: vytvořit zobrazení ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image36.png))
...
**Výpis 6 - Controllers\HomeController.vb (pomocí metod úpravy)**
...
**Obrázek 19**: Přidání zobrazení upravit o ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image38.png))
...
**Výpis 8 - Controllers\HomeController.vb (metody odstranění)**
...
**Obrázek 20**: zobrazení potvrzení odstranění ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image40.png))
...
**Obrázek 21**: Index zobrazení s odkaz pro úpravy ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image42.png))
...
**Obrázek 22**: Přidání zobrazení potvrzení odstranění ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image44.png))
...
Tento problém je snadné dostatečně opravit. Nejprve musíme Refaktorovat název domovské řadiče. Třída HomeController otevřete v editoru kódu sady Visual Studio, klikněte pravým tlačítkem na název třídy a vyberte možnost nabídky **přejmenovat**. Výběrem této možnosti nabídky, otevře se dialogové okno Přejmenovat.
...
**Obrázek 23**: refaktoring název řadiče ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image46.png))
...
**Obrázek 24**: V dialogovém okně přejmenovat ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image48.png))
...
**Obrázek 25**: žádný výchozí řadič ([Kliknutím zobrazit obrázek v plné velikosti](iteration-1-create-the-application-vb/_static/image50.png))
