...
---
<a name="iteration-7--add-ajax-functionality-c"></a>Iterace #7 – přidat Ajax funkce (C#)
====================
podle [Microsoft](https://github.com/microsoft)

[Stáhněte si kód](iteration-7-add-ajax-functionality-cs/_static/contactmanager_7_cs1.zip)
...
[![Aktualizace pouze kontakty](iteration-7-add-ajax-functionality-cs/_static/image1.jpg)](iteration-7-add-ajax-functionality-cs/_static/image1.png)

**Obrázek 01**: aktualizace pouze kontakty ([Kliknutím zobrazit obrázek v plné velikosti](iteration-7-add-ajax-functionality-cs/_static/image2.png))
...
**Výpis 3 - Controllers\ContactController.cs (Index metoda)**
...
**Obrázek 02**: stránka potvrzení odstranění ([Kliknutím zobrazit obrázek v plné velikosti](iteration-7-add-ajax-functionality-cs/_static/image4.png))
