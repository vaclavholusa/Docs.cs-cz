...
**Obrázek 01**: aktualizuje pouze kontakty ([kliknutím ji zobrazíte obrázek v plné velikosti](iteration-7-add-ajax-functionality-cs/_static/image2.png))
