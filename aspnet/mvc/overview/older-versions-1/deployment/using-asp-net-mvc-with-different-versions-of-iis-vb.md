...
**Obrázek 5**: kořenové chybí trasu chyby ([Kliknutím zobrazit obrázek v plné velikosti](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image10.png))
