...
[![Vytváření pro třídy SQL LINQ](displaying-a-table-of-database-data-cs/_static/image1.jpg)](displaying-a-table-of-database-data-cs/_static/image1.png)

**Obrázek 01**: vytváření třídy LINQ to SQL ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image2.png))
...
[![Model dat Entity Designer](displaying-a-table-of-database-data-cs/_static/image2.jpg)](displaying-a-table-of-database-data-cs/_static/image3.png)

**Obrázek 02**: Entity Data Model Designer ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image4.png))
...
[![Řadiči nabídka přidat](displaying-a-table-of-database-data-cs/_static/image3.jpg)](displaying-a-table-of-database-data-cs/_static/image5.png)

**Obrázek 03**: nabídce přidat řadič ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image6.png))
...
**Obrázek 04**: dialogové okno Přidat kontroler ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image8.png))
...
Třída MoviesDBEntities je v výpis 1, používá k reprezentování MoviesDB databáze. Pro tuto třídu použít, musíte importovat obor názvů MvcApplication1.Models takto:

pomocí MvcApplication1.Models;

Výraz *entity. MovieSet.ToList()* vrací sadu všech filmy z filmy databázové tabulky.
...
**Obrázek 05**: Přidání zobrazení ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image10.png))
...
**Obrázek 06**: Přidat zobrazení dialogu ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image12.png))
...
**Obrázek 07**: tabulku filmy ([Kliknutím zobrazit obrázek v plné velikosti](displaying-a-table-of-database-data-cs/_static/image14.png))
...
Zobrazení v výpis 4 obsahuje smyčka typu foreach, který iteruje v rámci všech videa. Pro každý film částečné MovieTemplate slouží k formátování videa. MovieTemplate je vykreslen metodou voláním metody helper RenderPartial().
