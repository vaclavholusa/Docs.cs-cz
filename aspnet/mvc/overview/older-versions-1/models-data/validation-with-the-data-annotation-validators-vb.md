...
**Obrázek 1**: Přidání odkazu na vazač modelu dat poznámky ([Kliknutím zobrazit obrázek v plné velikosti](validation-with-the-data-annotation-validators-vb/_static/image3.png))
...
Tento řádek kódu zaregistruje DataAnnotationsModelBinder jako výchozí vazač modelu pro celou aplikaci ASP.NET MVC.
...
- ReqularExpression – umožňuje ověřit, zda hodnota vlastnosti odpovídá zadanému regulárnímu výrazu vzoru.
...
**Obrázek 6**: validátory pomocí rozhraní Entity Framework ([Kliknutím zobrazit obrázek v plné velikosti](validation-with-the-data-annotation-validators-vb/_static/image14.png))
