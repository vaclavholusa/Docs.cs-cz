...
**Obrázek 02**: dialogové okno pro vytvoření projektu testů jednotek ([kliknutím ji zobrazíte obrázek v plné velikosti](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image4.png))
...
**Obrázek 03**: vytvoření databáze Microsoft SQL Server ([kliknutím ji zobrazíte obrázek v plné velikosti](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image6.png))
...
**Obrázek 04**: filmy databázové tabulky ([kliknutím ji zobrazíte obrázek v plné velikosti](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image8.png))
...
**Obrázek 08**: přidáte nový kontroler ASP.NET MVC ([kliknutím ji zobrazíte obrázek v plné velikosti](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image16.png))
...
**Výpis 2 – Controllers/HomeController.cs (upravená metoda indexu)**
...
**Obrázek 11**: Index zobrazení ([kliknutím ji zobrazíte obrázek v plné velikosti](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image22.png))
...
Nejdřív potřebujeme Generovat formulář pro úpravy. Tento krok je jednoduchý, protože Visual Studio vygeneruje formulář pro úpravy pro nás automaticky. Otevřete třídu HomeController.cs v editoru kódu sady Visual Studio a postupujte podle těchto kroků:
...
**Výpis 6 – Controllers\HomeController.cs (metod Edit)**
