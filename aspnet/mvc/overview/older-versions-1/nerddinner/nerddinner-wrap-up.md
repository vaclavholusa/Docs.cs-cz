...
---
<a name="nerddinner-wrap-up"></a>Aplikace Nerddinner
====================
...
Můžete také vyhledat skvělé technologie ASP.NET MVC, kurzy a videa na: [ https://www.asp.net/mvc ](../../../index.md) dalších skvělých knih ASP.NET MVC za chvíli publikuje. Můžu se aktualizovat tuto stránku a zahrnovat odkazy na další knihy, jakmile budou k dispozici.
