...
---
<a name="understanding-models-views-and-controllers-vb"></a>Principy modely, zobrazení a Kontrolery (VB)
====================
...
[![Dialogové okno Nový projekt](understanding-models-views-and-controllers-vb/_static/image1.jpg)](understanding-models-views-and-controllers-vb/_static/image1.png)

**Obrázek 01**: dialogové okno Nový projekt ([Kliknutím zobrazit obrázek v plné velikosti](understanding-models-views-and-controllers-vb/_static/image2.png))
...
[![Vytvořte jednotku Test – dialogové okno](understanding-models-views-and-controllers-vb/_static/image2.jpg)](understanding-models-views-and-controllers-vb/_static/image3.png)

**Obrázek 02**: dialogové okno Vytvořit testovací jednotky ([Kliknutím zobrazit obrázek v plné velikosti](understanding-models-views-and-controllers-vb/_static/image4.png))
...
Pokud rozbalíte složce řadiče, měli byste vidět soubor s názvem AccountController.vb a soubor s názvem HomeController.vb. Pokud rozbalíte složce zobrazení, měli byste vidět tři podsložky s názvem účet domů a sdílený. Pokud rozbalíte Domovská složka, se zobrazí dva další soubory s názvem About.aspx a Index.aspx (viz obrázek 3). Tyto soubory tvoří ukázkovou aplikaci součástí výchozí šablony ASP.NET MVC.
...
**Obrázek 03**: okno Průzkumníka řešení ([Kliknutím zobrazit obrázek v plné velikosti](understanding-models-views-and-controllers-vb/_static/image6.png))
...
[![Ladění není povoleno dialogové okno](understanding-models-views-and-controllers-vb/_static/image4.jpg)](understanding-models-views-and-controllers-vb/_static/image7.png)

**Obrázek 04**: ladění není povoleno dialogové okno ([Kliknutím zobrazit obrázek v plné velikosti](understanding-models-views-and-controllers-vb/_static/image8.png))
...
**Obrázek 05**: indexovou stránku ([Kliknutím zobrazit obrázek v plné velikosti](understanding-models-views-and-controllers-vb/_static/image10.png))
...
Řadič je právě třídy (například třída Visual Basic a C#). Ukázkové aplikace ASP.NET MVC zahrnuje řadič HomeController.vb umístěný ve složce řadiče. Obsah souboru HomeController.vb je uveden v výpis 2.
