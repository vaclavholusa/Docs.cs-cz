...
---
<a name="americas-next-top-model-view-controller-framework"></a>Prostředí řadiče zobrazení další nejvyšší modelu na Amerika
====================
podle [Phila Haacka](https://github.com/Haacked)

Zjistit, jak vytvořit jednoduchou aplikaci, která označuje některé klíčové funkce ASP.NET MVC. Také informace o zvýšení produktivity pomocí některé z nových nástrojů funkce nástrojů.
