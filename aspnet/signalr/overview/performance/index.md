...
====================
> Jak chcete maximalizovat výkon aplikací SignalR.


- [SignalR výkonu](signalr-performance.md)
- [Úvod do škálování v systému SignalR](scaleout-in-signalr.md)
...
- [Hustotu připojení SignalR testování pomocí Crank](signalr-connection-density-testing-with-crank.md)
- [Pomocí čítače výkonu SignalR v webové Role Azure](using-signalr-performance-counters-in-an-azure-web-role.md)
