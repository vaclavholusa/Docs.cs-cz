...
V rozhraní ASP.NET Web API, můžete použít atributy z [System.ComponentModel.DataAnnotations](https://msdn.microsoft.com/en-us/library/system.componentmodel.dataannotations.aspx) obor názvů nastavit pravidla ověřování pro vlastnosti modelu. Vezměte v úvahu následující modelu:
