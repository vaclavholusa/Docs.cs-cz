...
====================
> K vytvoření koncové body, které podporují OData verze 3 použijte rozhraní ASP.NET Web API.


- [Vytváření koncový bod OData v3](creating-an-odata-endpoint.md)
- [Podpora vztahy entit v OData v3](working-with-entity-relations.md)
