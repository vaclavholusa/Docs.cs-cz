...
---
<a name="using-dynamicpopulate-with-a-user-control-and-javascript-vb"></a>DynamicPopulate pomocí uživatelského ovládacího prvku a JavaScript (VB)
====================
podle [Christian Wenz](https://github.com/wenz)

[Stáhněte si kód](http://download.microsoft.com/download/d/8/f/d8f2f6f9-1b7c-46ad-9252-e1fc81bdea3e/dynamicpopulate2.vb.zip) nebo [stáhnout PDF](http://download.microsoft.com/download/b/6/a/b6ae89ee-df69-4c87-9bfb-ad1eb2b23373/dynamicpopulate2VB.pdf)
...
[![Přepínací tlačítka se nacházejí v uživatelského ovládacího prvku](using-dynamicpopulate-with-a-user-control-and-javascript-vb/_static/image2.png)](using-dynamicpopulate-with-a-user-control-and-javascript-vb/_static/image1.png)

Přepínací tlačítka se nacházejí v uživatelského ovládacího prvku ([Kliknutím zobrazit obrázek v plné velikosti](using-dynamicpopulate-with-a-user-control-and-javascript-vb/_static/image3.png))
