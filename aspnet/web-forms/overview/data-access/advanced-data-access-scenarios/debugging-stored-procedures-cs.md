...
Microsoft SQL Server 2005 byla navržená tak, aby nabízí integraci s [Common Language Runtime (CLR)](https://msdn.microsoft.com/netframework/aa497266.aspx), což je modul runtime používá všechna sestavení .NET. V důsledku toho systému SQL Server 2005 podporuje spravované databázové objekty. To znamená můžete vytvořit databázové objekty, jako jsou uložené procedury a uživatelem definované funkce (UDF) jako metody ve třídě C#. To umožňuje tyto uložené procedury a funkce UDF, abyste mohli využívat funkce v rozhraní .NET Framework a z vlastní třídy. Samozřejmě SQL Server 2005 taky poskytuje podporu pro databázové objekty T-SQL.
