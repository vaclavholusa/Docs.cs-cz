...
**Obrázek 2**: přidejte nový prvek ObjectDataSource s názvem `CategoriesDataSource` ([kliknutím ji zobrazíte obrázek v plné velikosti](displaying-summary-information-in-the-gridview-s-footer-cs/_static/image6.png))
...
**Obrázek 3**: mají ObjectDataSource vyvolat `CategoriesBLL` třídy `GetCategories()` – metoda ([kliknutím ji zobrazíte obrázek v plné velikosti](displaying-summary-information-in-the-gridview-s-footer-cs/_static/image9.png))
...
**Obrázek 6**: přidejte nový prvek ObjectDataSource s názvem `ProductsInCategoryDataSource` ([kliknutím ji zobrazíte obrázek v plné velikosti](displaying-summary-information-in-the-gridview-s-footer-cs/_static/image18.png))
...
**Obrázek 7**: mají ObjectDataSource vyvolat `GetProductsByCategoryID(categoryID)` – metoda ([kliknutím ji zobrazíte obrázek v plné velikosti](displaying-summary-information-in-the-gridview-s-footer-cs/_static/image21.png))
...
**Obrázek 12**: řádek zápatí prvku GridView má teď načervenalé barvu pozadí ([kliknutím ji zobrazíte obrázek v plné velikosti](displaying-summary-information-in-the-gridview-s-footer-cs/_static/image36.png))
...
**Obrázek 13**: řádek zápatí prvku GridView má teď načervenalé barvu pozadí ([kliknutím ji zobrazíte obrázek v plné velikosti](displaying-summary-information-in-the-gridview-s-footer-cs/_static/image39.png))
