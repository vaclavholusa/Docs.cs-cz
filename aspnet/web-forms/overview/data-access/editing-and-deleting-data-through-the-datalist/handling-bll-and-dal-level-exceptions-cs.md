...
[Stáhněte si ukázkovou aplikaci](http://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_38_CS.exe) nebo [stáhnout PDF](handling-bll-and-dal-level-exceptions-cs/_static/datatutorial38cs1.pdf)
...
[![Vrátí informace o produktu pomocí metody GetProducts()](handling-bll-and-dal-level-exceptions-cs/_static/image2.png)](handling-bll-and-dal-level-exceptions-cs/_static/image1.png)

**Obrázek 1**: vrátit na informace o produktu pomocí `GetProducts()` – metoda ([Kliknutím zobrazit obrázek v plné velikosti](handling-bll-and-dal-level-exceptions-cs/_static/image3.png))
...
**Obrázek 2**: každý produkt obsahuje tlačítko Upravit ([Kliknutím zobrazit obrázek v plné velikosti](handling-bll-and-dal-level-exceptions-cs/_static/image6.png))
...
[![Chybová zpráva se zobrazí, pokud uživatel vynechá požadované pole](handling-bll-and-dal-level-exceptions-cs/_static/image9.png)](handling-bll-and-dal-level-exceptions-cs/_static/image8.png)

**Obrázek 4**: chybová zpráva se zobrazí, pokud uživatel vynechá požadované pole ([Kliknutím zobrazit obrázek v plné velikosti](handling-bll-and-dal-level-exceptions-cs/_static/image10.png))


[![Chybová zpráva se zobrazí při zadávání záporné cena](handling-bll-and-dal-level-exceptions-cs/_static/image12.png)](handling-bll-and-dal-level-exceptions-cs/_static/image11.png)

**Obrázek 5**: chybová zpráva se zobrazí při zadávání záporné ceny ([Kliknutím zobrazit obrázek v plné velikosti](handling-bll-and-dal-level-exceptions-cs/_static/image13.png))
