...
**Obrázek 1**: je možné upravit každou položku v plně upravit DataList ([kliknutím ji zobrazíte obrázek v plné velikosti](performing-batch-updates-cs/_static/image3.png))
...
**Obrázek 3**: načtení dodavatele informací pomocí `GetSuppliers()` – metoda ([kliknutím ji zobrazíte obrázek v plné velikosti](performing-batch-updates-cs/_static/image9.png))
...
**Obrázek 5**: každý dodavatele v ovládacím prvku DataList je upravit ([kliknutím ji zobrazíte obrázek v plné velikosti](performing-batch-updates-cs/_static/image15.png))
