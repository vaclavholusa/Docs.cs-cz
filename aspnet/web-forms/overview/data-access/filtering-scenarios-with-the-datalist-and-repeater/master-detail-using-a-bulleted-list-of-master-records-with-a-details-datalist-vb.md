...
ms.locfileid: "37389635"
---
<a name="masterdetail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb"></a>Master/Detail s seznam hlavních záznamů s odrážkami podrobnostmi v prvku DataList (VB)
====================
...
**Obrázek 1**: na levé straně se zobrazí kategorii s názvem a celkový počet produktů ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image3.png))
...
**Obrázek 2**: The Repeater je ponechán v neurčitém stavu nalevo od prvku DataList ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image6.png))
...
**Obrázek 4**: zobrazené každou kategorii s názvem a číslem produkty ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image12.png))
...
**Obrázek 5**: přidejte nový sloupec, `CategoriesDataSource` ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image15.png))
...
**Obrázek 7**: vytvoření metody, pomocí příkazu SQL Ad-Hoc ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image19.png))
...
**Obrázek 8**: SQL příkaz vrátí Rows ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image22.png))
...
**Obrázek 10**: název nového TableAdapter s metod `FillWithNumberOfProducts` a `GetCategoriesAndNumberOfProducts` ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image28.png))
...
**Obrázek 13**: není zadán parametr zdroj *`categoryID`* parametr ([kliknutím ji zobrazíte obrázek v plné velikosti](master-detail-using-a-bulleted-list-of-master-records-with-a-details-datalist-vb/_static/image37.png))
