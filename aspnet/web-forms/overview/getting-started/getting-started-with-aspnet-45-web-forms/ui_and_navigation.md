...
[Úvod do programování webových stránek ASP.NET](https://msdn.microsoft.com/en-us/library/ms178125.aspx)   
[Přehled ovládacích prvků webového serveru technologie ASP.NET](https://msdn.microsoft.com/en-us/library/zsyt68f1.aspx)   
