...
2. <span data-ttu-id="1ee5b-146">V Průzkumníku řešení otevřete **Site.css** soubor umístěný v části **styly** složky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-146">In Solution Explorer, open the **Site.css** file located under the **Styles** folder.</span></span> <span data-ttu-id="1ee5b-147">Zajistěte, aby **textového editoru** nástroje se zobrazí na panelu nástrojů.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-147">Make sure the **Text Editor** tools are visible on the toolbar.</span></span> <span data-ttu-id="1ee5b-148">To lze provést, vyberte **zobrazení** | **panely nástrojů** nabídky a zkontrolujte **textového editoru** možnosti.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-148">To do that, select the **View** | **Toolbars** menu option, and check the **Text Editor** options.</span></span> <span data-ttu-id="1ee5b-149">Si všimnete, protože tuto novou verzi **komentář** tlačítko (![komentář – tlačítko](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image1.png) ) a **zrušte komentáře u** tlačítko (![zrušte komentář – tlačítko](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image2.png)) jsou povolená i u editor šablon stylů CSS.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-149">You will notice that, since this new version, the **Comment** button (![comment-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image1.png) ) and the **Uncomment** button (![uncomment-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image2.png) ) are also enabled for the CSS editor.</span></span>
    ...
    <span data-ttu-id="1ee5b-150">![Povolení editoru a šablon stylů CSS nástroje](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image3.png "povolení editoru a šablon stylů CSS nástroje")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-150">![Enabling Editor and CSS Tools](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image3.png "Enabling Editor and CSS Tools")</span></span>
...
5. <span data-ttu-id="1ee5b-159">Ujistěte se, že je povolena funkce Inteligentní odsazení.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-159">Make sure that the smart indentation feature is enabled.</span></span> <span data-ttu-id="1ee5b-160">Vyberte **nástroje** | **možnosti** možnosti nabídky a potom vyberte **textového editoru** | **šablon stylů CSS**  |  **Formátování** stránky v levém podokně na obrazovce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-160">Select the **Tools** | **Options** menu option, and then select the **Text Editor** | **CSS** | **Formatting** page in the left pane of the screen.</span></span> <span data-ttu-id="1ee5b-161">Zkontrolujte **hierarchické odsazení** možnost.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-161">Check the **Hierarchical indentation** option.</span></span>
    ...
    <span data-ttu-id="1ee5b-163">*Povolení hierarchické odsazení*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-163">*Enabling hierarchical indentation*</span></span>
...
1. <span data-ttu-id="1ee5b-197">V **Site.css** souboru, vyhledejte **záhlaví** šablon stylů CSS třídy definice (.header) a umístěte kurzor níže **/ \*ohraničení radius\* /** zástupný symbol pro přidání nové fragment kódu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-197">In the **Site.css** file, locate the **header** CSS class definition (.header) and place the cursor below the **/\*border radius\*/** placeholder to add a new snippet.</span></span> <span data-ttu-id="1ee5b-198">Stiskněte klávesu **Enter** k zobrazení seznamu IntelliSense a typ **radius** pro filtrování seznamu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-198">Press **Enter** to display the IntelliSense list and type **radius** to filter the list.</span></span> <span data-ttu-id="1ee5b-199">Vyberte **border-radius** možnost ze seznamu s klikněte a potom stiskněte klávesu **KARTĚ** klíč vložit fragment.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-199">Select the **border-radius** option from the list with a double click, and then press the **TAB** key to insert the snippet.</span></span> <span data-ttu-id="1ee5b-200">Poté zadejte velikost protokolu radius v pixelech a stiskněte klávesu **Enter**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-200">Then, type a radius size in pixels and press **Enter**.</span></span> <span data-ttu-id="1ee5b-201">Například zadejte **15px**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-201">For instance, type **15px**.</span></span>
    ...
    <span data-ttu-id="1ee5b-203">![Pomocí fragment border-radius](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "pomocí fragment border-radius")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-203">![Using a border-radius snippet](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "Using a border-radius snippet")</span></span>
...
6. <span data-ttu-id="1ee5b-213">Zobrazte seznam technologie IntelliSense, typ **stín pole** a stiskněte klávesu **KARTĚ** klíč dvakrát, chcete-li vložit fragment kódu stínové výchozí do definice třídy.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-213">Press enter to display the IntelliSense list, type **box-shadow** and press the **TAB** key twice to insert the default shadow code snippet inside the class definition.</span></span> <span data-ttu-id="1ee5b-214">Nastavte hodnoty stínové na **10px 10px 5px #888**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-214">Set the shadow values to **10px 10px 5px #888**.</span></span> <span data-ttu-id="1ee5b-215">Poté zadejte **border-radius** a Vložit fragment kódu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-215">Then, type **border-radius** and insert the code snippet.</span></span> <span data-ttu-id="1ee5b-216">Typ **15px** nastavit velikost protokolu radius a stiskněte klávesu **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-216">Type **15px** to set radius size and press **ENTER**.</span></span>
    ...
    <span data-ttu-id="1ee5b-218">*Zaoblenými hranami s stínové*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-218">*Rounded corners with shadow*</span></span>
...
6. <span data-ttu-id="1ee5b-257">Vrátit zpět změny schématu cílové pro ověření nástrojů výběr DOCTYPE: XHTML5 z rozevíracího seznamu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-257">Undo the changes to the Target Schema for Validation Toolbar, picking DOCTYPE: XHTML5 from the dropdown list.</span></span>
    ...
    <span data-ttu-id="1ee5b-258">![Použití Doctype v panelu nástrojů Úpravy zdrojového kódu HTML](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image25.png "použití Doctype v panelu nástrojů Úpravy zdrojového kódu HTML")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-258">![Use Doctype in HTML Source Editing toolbar](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image25.png "Use Doctype in HTML Source Editing toolbar")</span></span>
...
5. <span data-ttu-id="1ee5b-291">Nyní zkuste vložení ovládacího prvku v některé části stránky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-291">Now, try to insert a control in some part of the page.</span></span> <span data-ttu-id="1ee5b-292">Zkuste například vložení **GridView** ovládací prvek, ale místo zadání  **&lt;Gri,** začněte psát  **&lt;GV**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-292">For example, try to insert a **GridView** control, but instead of typing **&lt;Gri,** start typing **&lt;GV**.</span></span> <span data-ttu-id="1ee5b-293">Všimněte si, že IntelliSense seznamu jsou uvedeny **asp: GridView** ovládacího prvku.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-293">Notice that the IntelliSense list shows the **asp:GridView** control.</span></span>
    ...
    <span data-ttu-id="1ee5b-299">*Vkládání GridView s částečnou shodu a seznamy IntelliSense*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-299">*Inserting a GridView with IntelliSense lists and partial matching*</span></span>
...
4. <span data-ttu-id="1ee5b-390">V poslední řádek souboru, zápis libovolný řetězec jako **&quot;testování&quot;** (včetně uvozovek to znamená, je jako řetězec).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-390">In the last line of the file, write any string like **&quot;test&quot;** (include the quotation marks to indicate it is as string).</span></span> <span data-ttu-id="1ee5b-391">Zápis období vedle řetězec k zobrazení seznamu IntelliSense a vyberte **trim** možnost.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-391">Write a period next to the string to display the IntelliSense list, and select the **trim** option.</span></span>
    ...
    <span data-ttu-id="1ee5b-394">*Seznam technologie IntelliSense v jazyce JavaScript*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-394">*IntelliSense list in JavaScript*</span></span>

<a id="Ex3Task3"></a>

<a id="Task_3_-_XML_Documentation_for_JavaScript"></a>
#### <a name="task-3---xml-documentation-for-javascript"></a><span data-ttu-id="1ee5b-395">Úloha 3 – dokumentace XML pro JavaScript</span><span class="sxs-lookup"><span data-stu-id="1ee5b-395">Task 3 - XML Documentation for JavaScript</span></span>

<span data-ttu-id="1ee5b-396">V této úloze zaměříte funkcích nástroje Visual Studio pro dokumentace XML v jazyce JavaScript.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-396">In this task, you will explore Visual Studio features for XML documentation in JavaScript.</span></span> <span data-ttu-id="1ee5b-397">Uvidíte, že v seznamu JavaScript IntelliSense zobrazí dokumentace XML každé funkce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-397">You will see the JavaScript IntelliSense list now shows the XML documentation of each function.</span></span> <span data-ttu-id="1ee5b-398">Kromě toho bude zjišťovat funkci navigace v jazyce JavaScript.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-398">Additionally, you will discover the navigation feature in JavaScript.</span></span>

1. <span data-ttu-id="1ee5b-399">Otevřete **XMLDoc.js** soubor umístěný ve **skripty nebo vlastní** složce projektu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-399">Open **XMLDoc.js** file located in **Scripts/custom** project folder.</span></span> <span data-ttu-id="1ee5b-400">Tento soubor obsahuje dokumentace XML na každém z funkce jazyka JavaScript.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-400">This file contains XML documentation on each of the JavaScript functions.</span></span>

    <span data-ttu-id="1ee5b-401">![Dokumentace JavaScript XML integrované technologie IntelliSense,](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "integrované dokumentace JavaScript XML IntelliSense")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-401">![JavaScript XML documentation integrated to IntelliSense](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "JavaScript XML documentation integrated to IntelliSense")</span></span>

    <span data-ttu-id="1ee5b-402">*Dokumentace JavaScript XML integrované technologie IntelliSense*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-402">*JavaScript XML documentation integrated to IntelliSense*</span></span>
2. <span data-ttu-id="1ee5b-403">Pod **přidat** fungovat v **XMLDoc.js** souboru, vytvořte novou funkci s názvem **testování**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-403">Below **add** function in **XMLDoc.js** file, create a new function named **test**.</span></span>
3. <span data-ttu-id="1ee5b-404">V **testování** fungovat, volání **násobení** funkce, která přijímá dva parametry.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-404">In the **test** function, call the **multiply** function that receives two parameters.</span></span> <span data-ttu-id="1ee5b-405">Všimněte si pole popisu tlačítka se zobrazuje **násobení** funkce dokumentaci.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-405">Notice the tooltip box is showing the **multiply** function documentation.</span></span>

    [!code-javascript[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample9.js)]

    <span data-ttu-id="1ee5b-406">![Dokumentace XML pro funkce jazyka JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "dokumentace XML pro funkce jazyka JavaScript")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-406">![XML documentation for JavaScript functions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "XML documentation for JavaScript functions")</span></span>

    <span data-ttu-id="1ee5b-407">*Dokumentace XML pro funkce jazyka JavaScript*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-407">*XML documentation for JavaScript functions*</span></span>
4. <span data-ttu-id="1ee5b-408">Dokončení příkazu call funkce a typ *tečkou* o otevření seznamu IntelliSense pro vrácené hodnoty.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-408">Complete the function call statement and type a *dot* to open the IntelliSense list on the returned value.</span></span> <span data-ttu-id="1ee5b-409">Všimněte si, že je zjišťování sady Visual Studio **vrátit** hodnotu v dokumentaci, považuje hodnotu jako číslo.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-409">Notice that Visual Studio is detecting the **return** value in the documentation, treating the value as a number.</span></span>

    <span data-ttu-id="1ee5b-410">![Dokumentace XML pro návratové typy](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "dokumentace XML pro návratové typy")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-410">![XML documentation for return types](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "XML documentation for return types")</span></span>

    <span data-ttu-id="1ee5b-411">*Dokumentace XML pro návratové typy*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-411">*XML documentation for return types*</span></span>
5. <span data-ttu-id="1ee5b-412">Nyní vložte volání pro přidání funkce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-412">Now, insert a call to add function.</span></span> <span data-ttu-id="1ee5b-413">Všimněte si, že editoru JavaScript teď podporuje přetížení funkce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-413">Notice that the JavaScript editor now supports function overloads.</span></span> <span data-ttu-id="1ee5b-414">Když píšete název funkce, bude moci vyberte některé z dostupných přetížení zadané v dokumentaci.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-414">When you write a function name, you will be able to select any of the available overloads specified in the documentation.</span></span>

    <span data-ttu-id="1ee5b-415">![Dokumentace XML pro přetížení](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "dokumentace XML pro přetížení")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-415">![XML documentation for overloads](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "XML documentation for overloads")</span></span>

    <span data-ttu-id="1ee5b-416">*Dokumentace XML pro přetížení*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-416">*XML documentation for overloads*</span></span>
6. <span data-ttu-id="1ee5b-417">Otevřete **GotoDefinition.js** souborů a vyhledejte **$().html()** volání funkce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-417">Open **GotoDefinition.js** file and locate the **$().html()** function call.</span></span> <span data-ttu-id="1ee5b-418">Vyhledejte kurzor na **html**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-418">Locate the cursor on **html**.</span></span>
7. <span data-ttu-id="1ee5b-419">Stiskněte klávesu **F12** a přejděte k definici.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-419">Press **F12** and navigate to the definition.</span></span> <span data-ttu-id="1ee5b-420">Všimněte si teď můžete přístup a procházet bez použití kódu jazyka JavaScript **najít** nástroj.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-420">Notice you can now access and browse your JavaScript code without using the **Find** tool.</span></span>
8. <span data-ttu-id="1ee5b-421">Vyhledejte ukazatele na instrukce jQuery před blok signatury na konci souboru kódu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-421">Locate the cursor on the jQuery instruction prior to the signature block at the bottom of the code file.</span></span> <span data-ttu-id="1ee5b-422">Stiskněte klávesu **F12**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-422">Press **F12**.</span></span> <span data-ttu-id="1ee5b-423">Bude přejděte na soubor knihovny jQuery.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-423">You will navigate to the jQuery library file.</span></span> <span data-ttu-id="1ee5b-424">Všimněte si můžete taky přejít v souborech jQuery pomocí **F12**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-424">Notice you can also navigate across the jQuery files using **F12**.</span></span>

    <span data-ttu-id="1ee5b-425">![Navigace na definice, jQuery](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "přejdete na definice jQuery")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-425">![Navigating to jQuery definitions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "Navigating to jQuery definitions")</span></span>

    <span data-ttu-id="1ee5b-426">*Navigace na definice, jQuery*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-426">*Navigating to jQuery definitions*</span></span>

> [!NOTE]
> <span data-ttu-id="1ee5b-427">Ujistěte se, že GotoDefinition.js neobsahuje chyby syntaxe před uložením souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-427">Make sure that GotoDefinition.js has no syntax errors before saving the file.</span></span>


<a id="Exercise4"></a>

<a id="Exercise_4_Bundling_and_Minification"></a>
### <a name="exercise-4-bundling-and-minification"></a><span data-ttu-id="1ee5b-428">Cvičení 4: Sdružování a Minifikace</span><span class="sxs-lookup"><span data-stu-id="1ee5b-428">Exercise 4: Bundling and Minification</span></span>

<span data-ttu-id="1ee5b-429">Kolikrát své weby obsahují víc než jeden JavaScript nebo šablon stylů CSS souboru?</span><span class="sxs-lookup"><span data-stu-id="1ee5b-429">How many times do your websites include more than one JavaScript or CSS file?</span></span> <span data-ttu-id="1ee5b-430">Jde o velmi běžný scénář, kde sdružování a minimalizace může pomoci snížit velikost souboru a proveďte webu provádět rychleji.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-430">This is a very common scenario where bundling and minification can help to reduce the file size and make the site perform faster.</span></span> <span data-ttu-id="1ee5b-431">Nová funkce instalujícího v technologii ASP.NET 4.5 sady určitou sadu souborů JS nebo šablon stylů CSS do jednoho elementu a zmenší velikost podle zmenšování obsah (tj. odebrání není požadováno mezery, odebírání komentářů, snižuje identifikátory).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-431">The new bundling feature in ASP.NET 4.5 packs a set of JS or CSS files into a single element, and reduces its size by minifying the content ( i.e. removing not required blank spaces, removing comments, reducing identifiers ).</span></span>

<span data-ttu-id="1ee5b-432">Sdružování a minimalizace v technologii ASP.NET 4.5 se provádí v době běhu, aby proces můžete identifikovat uživatelský agent (např. aplikace Internet Explorer, Mozilla atd.) a proto komprese zlepšit cílení na uživatele prohlížeče (například odebírání vy, je Mozilla konkrétní Když požadavek pochází z Internet Exploreru).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-432">Bundling and minification in ASP.NET 4.5 is performed at runtime, so that the process can identify the user agent (for example IE, Mozilla, etc), and thus, improve the compression by targeting the user browser (for instance, removing stuff that is Mozilla specific when the request comes from IE).</span></span>

<span data-ttu-id="1ee5b-433">V tomto cvičení se dozvíte, jak povolit a používat různé typy sdružování a minimalizace v technologii ASP.NET 4.5.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-433">In this exercise, you will learn how to enable and use the different types of bundling and minification in ASP.NET 4.5.</span></span>

<a id="Ex4Task1"></a>

<a id="Task_1_-_Installing_the_Bundling_and_Minification_Package_from_NuGet"></a>
#### <a name="task-1---installing-the-bundling-and-minification-package-from-nuget"></a><span data-ttu-id="1ee5b-434">Úloha 1 – instalace sdružování a minimalizace balíček NuGet</span><span class="sxs-lookup"><span data-stu-id="1ee5b-434">Task 1 - Installing the Bundling and Minification Package from NuGet</span></span>

1. <span data-ttu-id="1ee5b-435">Pokud ještě není otevřené, spusťte **Visual Studio** a otevřete **WhatsNewASPNET.sln** řešení umístěný v **Source\WhatsNewASPNET** složky tohoto testovacího prostředí.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-435">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="1ee5b-436">Otevřete konzolu Správce balíčků NuGet.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-436">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="1ee5b-437">Chcete-li to provést, použijte nabídku **zobrazení** | **ostatní okna** | **Konzola správce balíčků**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-437">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>

    <span data-ttu-id="1ee5b-438">![Otevírání file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole správce balíčku](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "otevřením konzoly Správce balíčků")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-438">![Opening the package manager file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "Opening the package manager console")</span></span>

    <span data-ttu-id="1ee5b-439">*Otevření konzoly Správce balíčků*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-439">*Opening the package manager console*</span></span>
3. <span data-ttu-id="1ee5b-440">V **Konzola správce balíčků** typ **Install-Package Microsoft.Web.Optimization** a stiskněte klávesu **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-440">In the **Package Manager Console,** type **Install-Package Microsoft.Web.Optimization** and press **ENTER**.</span></span>

<a id="Ex4Task2"></a>

<a id="Task_2_-_Default_Bundles"></a>
#### <a name="task-2---default-bundles"></a><span data-ttu-id="1ee5b-441">Úloha 2 – výchozí sady</span><span class="sxs-lookup"><span data-stu-id="1ee5b-441">Task 2 - Default Bundles</span></span>

<span data-ttu-id="1ee5b-442">Nejjednodušší způsob, jak používat sdružování a minimalizace je umožnit výchozí sady.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-442">The simplest way to use bundling and minification is to enable the default bundles.</span></span> <span data-ttu-id="1ee5b-443">Tato metoda používá konvence, abyste mohli odkazovat připojené a minifikovaný verze pro JS a šablon stylů CSS soubory ve složce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-443">This method uses conventions to let you reference the bundled and minified version for the JS and CSS files in a folder.</span></span>

<span data-ttu-id="1ee5b-444">V této úloze se dozvíte, jak povolit odkazovat připojené a minifikovaný soubory JS a šablon stylů CSS a zobrazit výsledný výstup.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-444">In this task, you will learn how to enable and reference the bundled and minified JS and CSS files and view the resulting output.</span></span>

1. <span data-ttu-id="1ee5b-445">Pokud ještě není otevřené, spusťte **Visual Studio** a otevřete **WhatsNewASPNET.sln** řešení umístěný v **Source\WhatsNewASPNET** složky tohoto testovacího prostředí.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-445">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="1ee5b-446">V **Průzkumníku řešení**, rozbalte **styly**, **Scripts\custom** a **Scripts\bundle** složky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-446">In the **Solution Explorer**, expand the **Styles**, **Scripts\custom** and **Scripts\bundle** folders.</span></span>

    <span data-ttu-id="1ee5b-447">Všimněte si, že aplikace používá více než jeden šablon stylů CSS a JS souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-447">Notice that the application is using more than one CSS and JS file.</span></span>

    <span data-ttu-id="1ee5b-448">![Soubory více předlohy se styly a JavaScript v aplikaci](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "soubory více předlohy se styly a JavaScript v aplikaci")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-448">![Multiple Stylesheets and JavaScript files in the application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "Multiple Stylesheets and JavaScript files in the application")</span></span>

    <span data-ttu-id="1ee5b-449">*Více souborů předlohy se styly a JavaScript v aplikaci*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-449">*Multiple Stylesheets and JavaScript files in the application*</span></span>
3. <span data-ttu-id="1ee5b-450">Otevřete **Global.asax.cs** souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-450">Open the **Global.asax.cs** file.</span></span>

    <span data-ttu-id="1ee5b-451">Všimněte si, že nové **Microsoft.Web.Optimization** obor názvů je označeno jako komentář na začátku souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-451">Notice that the new **Microsoft.Web.Optimization** namespace is commented out at the beginning of the file.</span></span> <span data-ttu-id="1ee5b-452">Zrušením komentáře u použití direktiva k obsahují sdružování a minimalizace funkce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-452">Uncomment the using directive to include the bundling and minification features.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample10.cs)]
4. <span data-ttu-id="1ee5b-453">Vyhledejte **aplikace\_spustit** metoda.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-453">Locate the **Application\_Start** method.</span></span>

    <span data-ttu-id="1ee5b-454">Tato metoda zrušte komentář u volání EnableDefaultBundles, jak je znázorněno v následujícím fragmentu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-454">In this method, uncomment the EnableDefaultBundles call as shown in the snippet below.</span></span> <span data-ttu-id="1ee5b-455">To umožňuje nám tak, aby odkazovaly připojené kolekce souborů CSS ve složce pomocí cesty ke složce, a &quot;šablon stylů CSS&quot; nebo &quot;JS&quot; příponu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-455">This enables us to reference a bundled collection of CSS files in a folder by using the path to that folder, plus the &quot;CSS&quot; or the &quot;JS&quot; suffix.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample11.cs)]
5. <span data-ttu-id="1ee5b-456">Otevřete **Optimization.aspx** souborů a vyhledejte obsahu ovládací prvek pro **HeadContent**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-456">Open the **Optimization.aspx** file and locate the content control for **HeadContent**.</span></span>

    <span data-ttu-id="1ee5b-457">Všimněte si, že soubory šablon stylů CSS a soubory JS mít jedinou značku odkazované.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-457">Notice the CSS files and the JS files have a single referenced tag.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample12.aspx)]

    > [!NOTE]
    > <span data-ttu-id="1ee5b-458">Tento kód je pro účely ukázky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-458">This code is for demo purposes.</span></span> <span data-ttu-id="1ee5b-459">V ideálním případě bude odkazovat sad v souboru Site.Master.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-459">Ideally, you will reference the bundles in the Site.Master file.</span></span> <span data-ttu-id="1ee5b-460">V ukázkový kód zjistíte, že některé připojené soubory jsou také se na ně odkazovat soubor Site.Master provádění tohoto odkazu na poslední redundantní.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-460">In this sample code, you will find that some of the bundled files are also being referenced by the Site.Master file, making this last reference redundant.</span></span>
6. <span data-ttu-id="1ee5b-461">Všimněte si, že odkazy používají instalujícího názvů v **href** atribut k získání souborů CSS nebo JS ze styly a Scripts\custom složku v uvedeném pořadí.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-461">Notice that the links are using the bundling conventions in the **href** attribute to get all the CSS or JS files from the Styles and Scripts\custom folder respectively.</span></span>

    <span data-ttu-id="1ee5b-462">Cestu můžete použít **skripty nebo vlastní/JS** jak je uvedeno dále sady a všechny soubory JS uvnitř minifikaci **skripty nebo vlastní** složky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-462">You can use the path **Scripts/custom/JS** as shown below to bundle and minify all the JS files inside a **Scripts/custom** folder.</span></span> <span data-ttu-id="1ee5b-463">Toto je výchozí chování na výchozí sady.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-463">This is the default behavior with the default bundles.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample13.aspx)]
7. <span data-ttu-id="1ee5b-464">Otevřete **Styles\Site.css** souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-464">Open the **Styles\Site.css** file.</span></span>

    <span data-ttu-id="1ee5b-465">Všimněte si, že původní soubor CSS obsahuje zobrazují odsazené kód, mezery a komentáře, které zvětšit soubor.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-465">Notice that the original CSS file contains indented code, blank spaces and comments that enlarge the file.</span></span> <span data-ttu-id="1ee5b-466">(Také soubor JavaScript obsahuje mezery a komentáře).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-466">(Also the JavaScript file contains blank spaces and comments).</span></span>

    <span data-ttu-id="1ee5b-467">![Jeden z původní šablony stylů CSS soubory ve složce skripty](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "jeden z původní šablony stylů CSS soubory ve složce skripty")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-467">![One of the original CSS files in the Scripts folder](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "One of the original CSS files in the Scripts folder")</span></span>

    <span data-ttu-id="1ee5b-468">*Jeden z původní šablony stylů CSS souborů ve složce skripty*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-468">*One of the original CSS files in the Scripts folder*</span></span>
8. <span data-ttu-id="1ee5b-469">Stiskněte klávesu **F5** spusťte aplikaci a přejít na **optimalizace** stránky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-469">Press **F5** to run the application and navigate to the **Optimization** page.</span></span>
9. <span data-ttu-id="1ee5b-470">Klikněte na **šablon stylů CSS sady** odkaz ke stažení a otevřete soubor.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-470">Click on the **CSS Bundle** link to download and open the file.</span></span>

    <span data-ttu-id="1ee5b-471">Projděte si soubor minifikovaný připojené.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-471">Check out the minified bundled file.</span></span> <span data-ttu-id="1ee5b-472">Si všimněte, že byly odstraněny všechny mezery, komentáře a odsazení znaky, generování menší soubor.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-472">You will notice that all the blank spaces, comments and indentation characters have been removed, generating a smaller file.</span></span>

    <span data-ttu-id="1ee5b-473">![Soubory šablon stylů CSS v sadě](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "soubory dodávat šablon stylů CSS")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-473">![Bundled CSS files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "Bundled CSS files")</span></span>

    <span data-ttu-id="1ee5b-474">*Připojené soubory šablon stylů CSS*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-474">*Bundled CSS files*</span></span>
10. <span data-ttu-id="1ee5b-475">Klikněte na tlačítko **JS sady** odkazu k otevření souboru JavaScript dodávat.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-475">Now click the **JS Bundle** link to open the JavaScript bundled file.</span></span> <span data-ttu-id="1ee5b-476">Průzkumník upozornění můžete bezpečně ignorovat.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-476">You can safely disregard the explorer warning.</span></span> <span data-ttu-id="1ee5b-477">Všimněte si, soubory jazyka JavaScript v části **vlastní** složky jsou taky spojeno dohromady a minifikovaný.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-477">Notice the JavaScript files under the **custom** folder are also bundled and minified.</span></span>

    <span data-ttu-id="1ee5b-478">![JavaScript soubory v sadě](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "soubory dodávat JavaScript")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-478">![Bundled JavaScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "Bundled JavaScript files")</span></span>

    <span data-ttu-id="1ee5b-479">*Připojené soubory jazyka JavaScript*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-479">*Bundled JavaScript files*</span></span>

    <span data-ttu-id="1ee5b-480">Povolení komprese pro soubory šablon stylů CSS nebo JS bylo mnohem složitější v předchozí verzi technologie ASP.NET.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-480">Enabling compression for CSS or JS files was much more complicated in previous ASP.NET version.</span></span> <span data-ttu-id="1ee5b-481">Nyní, jako jste viděli, stačí přidat jeden řádek v *Global.asax* souboru povolit sdružování a připojené soubory pak odkazovat z vaší lokality.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-481">Now, as you have seen, you just need to add one line in the *Global.asax* file to enable bundling, and then reference the bundled files from your site.</span></span>

<a id="Ex4Task3"></a>

<a id="Task_3_-_Static_Bundles"></a>
#### <a name="task-3---static-bundles"></a><span data-ttu-id="1ee5b-482">Úloha 3 – statické sady</span><span class="sxs-lookup"><span data-stu-id="1ee5b-482">Task 3 - Static Bundles</span></span>

<span data-ttu-id="1ee5b-483">Statické sady přístupu umožňuje přizpůsobit sadu souborů sady, odkaz a minimalizaci metoda, která bude použita.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-483">The static bundle approach allows you to customize the set of files to bundle, the reference and the minification method that will be used.</span></span>

<span data-ttu-id="1ee5b-484">V této úloze nakonfigurujete sady statické definovat určitou sadu souborů sady a minifikaci.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-484">In this task, you will configure a static bundle to define a specific set of files to bundle and minify.</span></span>

1. <span data-ttu-id="1ee5b-485">Zavřete prohlížeč.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-485">Close the browser.</span></span>
2. <span data-ttu-id="1ee5b-486">Otevřete **Global.asax.cs** souborů a vyhledejte **aplikace\_spustit** metoda.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-486">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
3. <span data-ttu-id="1ee5b-487">Zrušte komentář kódu statických sady, jak je znázorněno v následujícím kódu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-487">Uncomment the static bundle code as shown in the code below.</span></span>

    <span data-ttu-id="1ee5b-488">Definování statické sadu, která se bude odkazovat s &quot; **~/StaticBundle** &quot; virtuální cestou a použití **JsMinify** pro minimalizaci všechny zadané soubory s **AddFile** metoda.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-488">You are defining a static bundle that will be referenced with the &quot;**~/StaticBundle**&quot; virtual path and use **JsMinify** for minification of all the specified files with the **AddFile** method.</span></span> <span data-ttu-id="1ee5b-489">Nakonec přidáváte statické sada, která má **BundleTable** a jeho povolení.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-489">Finally, you are adding the static bundle to the **BundleTable** and enabling it.</span></span>

    <span data-ttu-id="1ee5b-490">Všimněte si, že nejsou soubory umístěné na stejném místě; To je Další výhodou přes výchozí sdružování.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-490">Notice that the files are not located in the same place; this is another advantage over the default bundling.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample14.cs)]
4. <span data-ttu-id="1ee5b-491">Otevřete **Optimization.aspx** souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-491">Open the **Optimization.aspx** file.</span></span>

    <span data-ttu-id="1ee5b-492">Všimněte si, že odkaz na **statické JS sady** je pomocí cesty deklarujete při konfiguraci sady statické v souboru Global.asax.cs: **/StaticBundle**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-492">Notice that the link to **Static JS Bundle** is using the path you have declared when you configured the static bundle in the Global.asax.cs file: **/StaticBundle**.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample15.aspx)]
5. <span data-ttu-id="1ee5b-493">Stiskněte klávesu **F5** aplikaci spustit, a potom přejděte na **optimalizace** stránky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-493">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
6. <span data-ttu-id="1ee5b-494">Klikněte na **statické JS sady** odkazu k otevření souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-494">Click on the **Static JS Bundle** link to open the file.</span></span>

    <span data-ttu-id="1ee5b-495">Všimněte si, že minifikovaný dodávat soubor JavaScript je výstup pro všechny soubory JavaScript nakonfigurované v souboru statické sady v cestě &quot;/StaticBundle&quot;.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-495">Notice that the minified bundled JavaScript file is the output for all the JavaScript files configured in the static bundle file under the path &quot;/StaticBundle&quot;.</span></span>

    <span data-ttu-id="1ee5b-496">![Statické soubory sady JavaScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "JavaScript statické soubory sady")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-496">![Static JavaScript files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "Static JavaScript files bundle")</span></span>

    <span data-ttu-id="1ee5b-497">*Statické soubory JavaScript sady*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-497">*Static JavaScript files bundle*</span></span>
7. <span data-ttu-id="1ee5b-498">Zavřete prohlížeč a vraťte se k sadě Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-498">Close the browser and return to Visual Studio.</span></span>

<a id="Ex4Task4"></a>

<a id="Task_4_-_Dynamic_Folder_Bundles"></a>
#### <a name="task-4---dynamic-folder-bundles"></a><span data-ttu-id="1ee5b-499">Úloha 4 – složka dynamické sady</span><span class="sxs-lookup"><span data-stu-id="1ee5b-499">Task 4 - Dynamic Folder Bundles</span></span>

<span data-ttu-id="1ee5b-500">V této úloze se dozvíte, jak nakonfigurovat dynamické složky sad.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-500">In this task, you will learn how to configure dynamic folder bundles.</span></span> <span data-ttu-id="1ee5b-501">Dynamické sdružování je, že můžete zahrnout statické JavaScript, stejně jako ostatní soubory jazyky, které kompilovaný do jazyka JavaScript a proto vyžadovat některé zpracování předtím, než se spustí sdružování.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-501">The power of dynamic bundling is that you can include static JavaScript, as well as other files in languages that compiles into JavaScript, and thus, require some processing before the bundling is executed.</span></span>

<span data-ttu-id="1ee5b-502">V tomto příkladu se dozvíte, jak používat **DynamicFolderBundle** třídy za účelem vytvoření dynamického sady pro soubory, které jsou napsané v CofeeScript.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-502">In this example, you will learn how to use the **DynamicFolderBundle** class to create a dynamic bundle for files written in CofeeScript.</span></span> <span data-ttu-id="1ee5b-503">CofeeScript je programovací jazyk kompilovaný do jazyka JavaScript a nabízí jednodušší syntaxi pro psaní kódu jazyka JavaScript, rozšíření jako stručný výtah a čitelnost jazyce JavaScript.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-503">CofeeScript is a programming language that compiles into JavaScript and provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability.</span></span>

1. <span data-ttu-id="1ee5b-504">Otevřete **Global.asax.cs** souborů a vyhledejte **aplikace\_spustit** metoda.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-504">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
2. <span data-ttu-id="1ee5b-505">Zrušte komentář kódu dynamické sady, jak je znázorněno v následujícím kódu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-505">Uncomment the dynamic bundle code as shown in the code below.</span></span>

    <span data-ttu-id="1ee5b-506">Definování sady dynamické složky, který bude používat **CoffeeMinify** vlastní minimalizace procesor, které se vztahuje pouze na soubory s &quot; **.coffee** &quot; (rozšíření CoffeeScript soubory).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-506">You are defining a dynamic folder bundle that will use the **CoffeeMinify** custom minification processor that will only apply to the files with the &quot;**.coffee**&quot; extension (CoffeeScript files).</span></span> <span data-ttu-id="1ee5b-507">Všimněte si, že vzor hledání můžete vybrat soubory sady ve složce, jako je třeba se\*.coffee'.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-507">Notice that you can use a search pattern to select the files to bundle within a folder, like '\*.coffee'.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample16.cs)]
3. <span data-ttu-id="1ee5b-508">Otevřete konzolu Správce balíčků NuGet.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-508">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="1ee5b-509">Chcete-li to provést, použijte nabídku **zobrazení** | **ostatní okna** | **Konzola správce balíčků**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-509">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>
4. <span data-ttu-id="1ee5b-510">V **Konzola správce balíčků** typ **Install-Package CoffeeSharp** a stiskněte klávesu **ENTER**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-510">In the **Package Manager Console,** type **Install-Package CoffeeSharp** and press **ENTER**.</span></span>
5. <span data-ttu-id="1ee5b-511">Klikněte **zobrazit všechny soubory** tlačítka na **Průzkumníku řešení** okno</span><span class="sxs-lookup"><span data-stu-id="1ee5b-511">Click the **Show All Files** button in the **Solution Explorer** window</span></span>

    <span data-ttu-id="1ee5b-512">![Zobrazení všech souborů](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "zobrazení všech souborů")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-512">![Showing all files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "Showing all files")</span></span>

    <span data-ttu-id="1ee5b-513">*Zobrazení všech souborů*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-513">*Showing all files*</span></span>
6. <span data-ttu-id="1ee5b-514">Klikněte pravým tlačítkem **CoffeeMinify.cs** v soubor **Průzkumníku řešení** a vyberte **zahrnout do projektu**</span><span class="sxs-lookup"><span data-stu-id="1ee5b-514">Right click the **CoffeeMinify.cs** file in the **Solution Explorer** and select **Include in Project**</span></span>

    <span data-ttu-id="1ee5b-515">![Zahrnout soubor CoffeeMinify.cs v projektu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "zahrnout soubor CoffeeMinify.cs v projektu")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-515">![Include the CoffeeMinify.cs file in the project](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "Include the CoffeeMinify.cs file in the project")</span></span>

    <span data-ttu-id="1ee5b-516">*Zahrnout soubor CoffeeMinify.cs v projektu*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-516">*Include the CoffeeMinify.cs file in the project*</span></span>
7. <span data-ttu-id="1ee5b-517">Otevřete **CoffeeMinify.cs** souboru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-517">Open the **CoffeeMinify.cs** file.</span></span>

    <span data-ttu-id="1ee5b-518">Tato třída dědí od JsMinify k minifikaci vyplývající z CoffeeScript kompilace kódu JavaScript výstup.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-518">This class inherits from JsMinify to minify the JavaScript output resulting from the CoffeeScript code compilation.</span></span> <span data-ttu-id="1ee5b-519">Zavolá CoffeeScript kompilátoru nejprve generovat kód jazyka JavaScript a pak se odešle do metodu JsMinify.Process k minifikaci výsledný kód.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-519">It calls the CoffeeScript compiler to generate the JavaScript code first, and then it sends it to the JsMinify.Process method to minify the resulting code.</span></span>

    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample17.cs)]
8. <span data-ttu-id="1ee5b-520">Otevřete **Script1.coffee** a **Script2.coffee** souborů z **skripty nebo sady** složky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-520">Open the **Script1.coffee** and **Script2.coffee** files from the **Scripts/bundle** folder.</span></span>

    <span data-ttu-id="1ee5b-521">Tyto soubory bude obsahovat kód CoffeScript sestavují při provádění sdružování pomocí třídy CoffeeMinify.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-521">These files will include the CoffeScript code to be compiled while performing the bundling with the CoffeeMinify class.</span></span>

    <span data-ttu-id="1ee5b-522">Pro účely jednoduchost jsou soubory CoffeeScript zadat pouze včetně CoffeeScript ukázkový kód.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-522">For simplicity purposes, the CoffeeScript files provided are only including CoffeeScript sample code.</span></span> <span data-ttu-id="1ee5b-523">Komentáře jsou vyloučeny JsMinify procesem.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-523">The comments are excluded by the JsMinify process.</span></span>

    <span data-ttu-id="1ee5b-524">![Soubory CoffeeScript](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "soubory CoffeeScript")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-524">![CoffeeScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript files")</span></span>

    <span data-ttu-id="1ee5b-525">*Soubory CoffeeScript*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-525">*CoffeeScript files*</span></span>

    > [!NOTE]
    > <span data-ttu-id="1ee5b-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) nabízí jednodušší syntaxi pro psaní kódu jazyka JavaScript, rozšíření jako stručný výtah a čitelnost jazyce JavaScript, jakož i přidávání dalších funkcí jako pole míru porozumění a porovnávání vzorů.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability, as well as adding other features like array comprehension and pattern matching.</span></span>
9. <span data-ttu-id="1ee5b-527">Otevřete **Optimization.aspx** souboru a najděte sady odkazy.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-527">Open the **Optimization.aspx** file and locate the bundle links.</span></span>

    <span data-ttu-id="1ee5b-528">Všimněte si, že odkaz na **dynamické sady JS** odkazuje **skripty nebo sady** složky pomocí **/kávy** přípon, které jste nakonfigurovali pro sadu složek dynamické.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-528">Notice that the link to **Dynamic JS Bundle** is referencing the **Scripts/bundle** folder by using the **/Coffee** suffix you configured for the dynamic folder bundle.</span></span>

    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample18.aspx)]
10. <span data-ttu-id="1ee5b-529">Stiskněte klávesu **F5** aplikaci spustit, a potom přejděte na **optimalizace** stránky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-529">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
11. <span data-ttu-id="1ee5b-530">Klikněte na **dynamické sady JS** odkazu k otevření vygenerovaný soubor.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-530">Click on the **Dynamic JS Bundle** link to open the generated file.</span></span>

    <span data-ttu-id="1ee5b-531">Všimněte si, že obsahuje pouze obsah, který je zahrnutý v této sadě **.coffee** soubory.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-531">Notice that the content that was included in this bundle only contains **.coffee** files.</span></span> <span data-ttu-id="1ee5b-532">Můžete také zjistí, že kód CoffeeScript byl zkompilován pro jazyk JavaScript a řádky komentované byla odebrána.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-532">You can also see that the CoffeeScript code was compiled to JavaScript and the commented-out lines has been removed.</span></span>

    <span data-ttu-id="1ee5b-533">![Dynamické soubory JS sady](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "dynamické JS soubory sady")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-533">![Dynamic JS files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "Dynamic JS files bundle")</span></span>

    <span data-ttu-id="1ee5b-534">*Dynamické sady soubory JS*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-534">*Dynamic JS files bundle*</span></span>

> [!NOTE]
> <span data-ttu-id="1ee5b-535">Kromě toho můžete nasadit tuto aplikaci do následující weby systému Windows Azure [příloha B: publikování aplikace ASP.NET MVC 4 pomocí nástroje nasazení webu](#AppendixB).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-535">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixB).</span></span>


<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="1ee5b-536">Souhrn</span><span class="sxs-lookup"><span data-stu-id="1ee5b-536">Summary</span></span>

<span data-ttu-id="1ee5b-537">Toto testovací prostředí vám umožní pochopit, co je nového v technologii ASP.NET a vývoj webů v sadě Visual Studio 2012 a jak využívat řadu vylepšení v sadě Visual Studio 2012.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-537">This lab helps you to understand what New in ASP.NET and Web Development in Visual Studio 2012 is and how to take advantage of the variety of enhancements in Visual Studio 2012.</span></span>

<span data-ttu-id="1ee5b-538">Provedením tohoto testovacího prostředí Hands-On mít dozvědět, jak používat nové funkce a vylepšení v aplikaci Visual Studio 2012 editory pro šablon stylů CSS, JavaScript a HTML.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-538">By completing this Hands-On Lab, you have learnt how to use the new features and improvements in Visual Studio 2012 Editors for CSS, JavaScript and HTML.</span></span> <span data-ttu-id="1ee5b-539">Kromě toho mají dozvědět, jak Visual Studio 2012 implementuje předdefinované sdružování a minimalizace.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-539">In addition, you have learnt how Visual Studio 2012 implements built-in bundling and minification.</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="1ee5b-540">Příloha A: instalaci sady Visual Studio Express 2012 pro Web</span><span class="sxs-lookup"><span data-stu-id="1ee5b-540">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="1ee5b-541">Můžete nainstalovat **Microsoft Visual Studio Express 2012 pro Web** nebo jiný &quot;Express&quot; pomocí verze **[instalačního programu webové platformy Microsoft](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-541">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="1ee5b-542">Následující pokyny vás provede kroky potřebné k instalaci *Visual studio Express 2012 pro Web* pomocí *instalačního programu webové platformy Microsoft*.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-542">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="1ee5b-543">Přejděte na [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-543">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="1ee5b-544">Případně, pokud jste již nainstalovali instalačního programu webové platformy, můžete otevřít a vyhledejte produktu &quot; <em>Visual Studio Express 2012 pro Web se sadou Windows Azure SDK</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-544">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="1ee5b-545">Klikněte na **nyní nainstalovat**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-545">Click on **Install Now**.</span></span> <span data-ttu-id="1ee5b-546">Pokud nemáte **instalačního programu webové platformy** budete přesměrováni na stáhněte a nainstalujte ji jako první.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-546">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="1ee5b-547">Jednou **instalačního programu webové platformy** je otevřený, klikněte na tlačítko **nainstalovat** zahájíte instalaci.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-547">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="1ee5b-548">![Nainstalovat Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "nainstalovat Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-548">![Install Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="1ee5b-549">*Nainstalovat Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-549">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="1ee5b-550">Číst všechny produkty se licence a podmínky a klikněte na tlačítko **souhlasím** pokračujte.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-550">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>
    ...
    <span data-ttu-id="1ee5b-552">*Vyjádření souhlasu s podmínkami licence*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-552">*Accepting the license terms*</span></span>
5. <span data-ttu-id="1ee5b-553">Počkejte na dokončení procesu stahování a instalaci.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-553">Wait until the downloading and installation process completes.</span></span>

    ![Průběh instalace](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image61.png)

    <span data-ttu-id="1ee5b-555">*Průběh instalace*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-555">*Installation progress*</span></span>
6. <span data-ttu-id="1ee5b-556">Po dokončení instalace, klikněte na tlačítko **Dokončit**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-556">When the installation completes, click **Finish**.</span></span>

    ![Instalace byla dokončena.](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image62.png)

    <span data-ttu-id="1ee5b-558">*Instalace byla dokončena.*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-558">*Installation completed*</span></span>
7. <span data-ttu-id="1ee5b-559">Klikněte na tlačítko **ukončení** ukončíte instalační program webové platformy.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-559">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="1ee5b-560">Chcete-li spustit nástroj Visual Studio Express pro Web, přejděte na **spustit** obrazovky a začít psát &quot; **VS Express**&quot;, klikněte na **VS Express pro Web** dlaždice.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-560">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express pro Web dlaždice](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image63.png)

    <span data-ttu-id="1ee5b-562">*VS Express pro Web dlaždice*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-562">*VS Express for Web tile*</span></span>
...
## <a name="appendix-b-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="1ee5b-563">Příloha B: publikování aplikace ASP.NET MVC 4 pomocí nástroje nasazení webu</span><span class="sxs-lookup"><span data-stu-id="1ee5b-563">Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="1ee5b-564">Tento dodatek vám ukáže, jak vytvořit nový web z portálu Windows Azure Management Portal a publikovat aplikace, kterou jste získali podle testovacím prostředí, využívat výhod nasazení webu publikování funkce poskytované služby Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-564">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="Ex1Task1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="1ee5b-565">Úloha 1 – Vytvoření nového webu ze systému Windows Azure Portal</span><span class="sxs-lookup"><span data-stu-id="1ee5b-565">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="1ee5b-566">Přejděte na [Windows Azure Management Portal](https://manage.windowsazure.com/) a přihlaste se pomocí přihlašovacích údajů společnosti Microsoft, které jsou spojené s vaším předplatným.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-566">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="1ee5b-567">S Windows Azure můžete bezplatné hostování 10 webů ASP.NET a pak škálujte podle rozšiřujícího se provozu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-567">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="1ee5b-568">Můžete si zaregistrovat [zde](http://aka.ms/aspnet-hol-azure).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-568">You can sign up [here](http://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="1ee5b-569">![Přihlaste se k portálu Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Přihlaste se k portálu Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-569">![Log on to Windows Azure portal](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="1ee5b-570">*Přihlaste se k Windows Azure Management Portal*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-570">*Log on to Windows Azure Management Portal*</span></span>
2. <span data-ttu-id="1ee5b-571">Klikněte na tlačítko **nový** na panelu příkazů.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-571">Click **New** on the command bar.</span></span>

    <span data-ttu-id="1ee5b-572">![Vytvoření nového webu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "vytváření nového webu")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-572">![Creating a new Web Site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="1ee5b-573">*Vytvoření nového webu*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-573">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="1ee5b-574">Klikněte na tlačítko **výpočetní** | **webu**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-574">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="1ee5b-575">Potom vyberte **rychle vytvořit** možnost.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-575">Then select **Quick Create** option.</span></span> <span data-ttu-id="1ee5b-576">Zadejte adresu URL k dispozici pro nový web a klikněte na tlačítko **vytvoření webu**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-576">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="1ee5b-577">Web systému Windows Azure je hostitel pro spouštění v cloudu, ve kterém můžete řídit a spravovat webovou aplikaci.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-577">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="1ee5b-578">Možnost rychle vytvořit můžete nasadit hotové webové aplikace na Windows Azure web z mimo portál.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-578">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="1ee5b-579">Postup pro nastavení databáze neobsahuje.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-579">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="1ee5b-580">![Vytvoření nového webu pomocí metody rychlého vytvoření](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "vytváření nového webu pomocí metody rychlého vytvoření")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-580">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="1ee5b-581">*Vytvoření nového webu pomocí metody rychlého vytvoření*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-581">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="1ee5b-582">Počkejte, dokud nové **webu** je vytvořena.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-582">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="1ee5b-583">Po vytvoření webu klikněte na odkaz v části **URL** sloupce.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-583">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="1ee5b-584">Zkontrolujte, zda je funkční nový web.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-584">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="1ee5b-585">![Procházení na nový web](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "procházení na nový web")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-585">![Browsing to the new web site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="1ee5b-586">*Procházení na nový web*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-586">*Browsing to the new web site*</span></span>

    <span data-ttu-id="1ee5b-587">![Webový server spuštěn](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "webu systémem")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-587">![Web site running](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "Web site running")</span></span>

    <span data-ttu-id="1ee5b-588">*Spuštění webu*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-588">*Web site running*</span></span>
6. <span data-ttu-id="1ee5b-589">Přejděte zpět na portál a klikněte na název webu v části **název** sloupec pro zobrazení stránky pro správu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-589">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="1ee5b-590">![Otevření stránky Správa webu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "otevření stránek správu webového serveru")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-590">![Opening the web site management pages](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="1ee5b-591">*Otevření stránek správu webového serveru*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-591">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="1ee5b-592">V **řídicí panel** v části **rychlého přehledu** klikněte na položku **stažení profilu publikování** odkaz.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-592">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="1ee5b-593">*Profilu publikování* obsahuje všechny informace požadované pro publikování webové aplikace na web služby Windows Azure pro každou metodu povoleno publikace.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-593">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="1ee5b-594">Profil publikování obsahuje adresy URL, přihlašovací údaje uživatele a řetězců databází, které jsou potřebné k připojení k a ověřování na základě těchto koncových bodů, pro které je metoda publikace povolena.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-594">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="1ee5b-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express pro Web** a **sadu Microsoft Visual Studio 2012** podporu čtení publikační profily k automatické konfiguraci těchto programů pro publikování webové aplikace na weby služby Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="1ee5b-596">![Na webu stažení profilu publikování](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "stahování webové stránky profilu publikování")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-596">![Downloading the web site publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="1ee5b-597">*Na webu stažení profilu publikování*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-597">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="1ee5b-598">Stáhněte si soubor profil publikování do vhodného umístění.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-598">Download the publish profile file to a known location.</span></span> <span data-ttu-id="1ee5b-599">Dále v tomto cvičení uvidíte jak používat tento soubor k publikování webové aplikace na weby systému Windows Azure ze sady Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-599">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="1ee5b-600">![Ukládání souboru profilu publikování](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "ukládání profilu publikování")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-600">![Saving the publish profile file](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "Saving the publish profile")</span></span>

    <span data-ttu-id="1ee5b-601">*Ukládání souboru profilu publikování*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-601">*Saving the publish profile file*</span></span>

<a id="Ex1Task2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="1ee5b-602">Úloha 2 – konfigurování serveru databáze</span><span class="sxs-lookup"><span data-stu-id="1ee5b-602">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="1ee5b-603">Pokud vaše aplikace využívá systému SQL Server, databáze, budete muset vytvořit databázi SQL server.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-603">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="1ee5b-604">Pokud chcete nasadit jednoduchou aplikaci, která nepoužívá systém SQL Server může tuto úlohu přeskočit.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-604">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="1ee5b-605">Budete potřebovat databázi SQL serveru pro ukládání databázi aplikace.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-605">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="1ee5b-606">Databáze SQL servery můžete zobrazit ze svého předplatného na portál Windows Azure Management **databází Sql** | **servery** | **serveru Řídicí panel**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-606">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="1ee5b-607">Pokud nemáte server vytvořeno, můžete vytvořit jeden pomocí **přidat** tlačítka na panelu příkazů.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-607">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="1ee5b-608">Poznamenejte si **název serveru a adresa URL, správce přihlašovací jméno a heslo**, jako je použijete v další úkoly.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-608">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="1ee5b-609">Nevytvářejte databáze ještě, jak bude vytvořen v pozdější fázi.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-609">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="1ee5b-610">![Řídicí panel serveru databáze SQL](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "řídicího panelu serveru databáze SQL")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-610">![SQL Database Server Dashboard](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="1ee5b-611">*Řídicí panel serveru databáze SQL*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-611">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="1ee5b-612">V dalším úkolem budete testovat připojení k databázi ze sady Visual Studio, proto je nutné zahrnout místní IP adresa serveru seznamu **povolené IP adresy**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-612">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="1ee5b-613">To lze provést, klikněte na tlačítko **konfigurace**, vyberte IP adresu z **aktuální IP adresa klienta** a vkládání na **počáteční IP adresa** a **Koncová IP adresa** textových polí.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-613">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes.</span></span> <span data-ttu-id="1ee5b-614">Zadejte název pravidla a klikněte ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) tlačítko.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-614">Enter a name for the rule and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) button.</span></span>

    ![Přidávání IP adresy klienta](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image74.png)

    <span data-ttu-id="1ee5b-616">*Přidávání IP adresy klienta*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-616">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="1ee5b-617">Jednou **IP adresa klienta** je povolené IP adresy do seznamu, klikněte na **Uložit** potvrďte změny.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-617">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Potvrzení změn](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image75.png)

    <span data-ttu-id="1ee5b-619">*Potvrzení změn*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-619">*Confirm Changes*</span></span>

<a id="Ex1Task3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="1ee5b-620">Úloha 3 – publikování aplikace ASP.NET MVC 4 pomocí nástroje nasazení webu</span><span class="sxs-lookup"><span data-stu-id="1ee5b-620">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="1ee5b-621">Přejděte zpět na ASP.NET MVC 4 řešení.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-621">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="1ee5b-622">V **Průzkumníku řešení**, klikněte pravým tlačítkem na webový projekt a vyberte **publikovat**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-622">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="1ee5b-623">![Publikování aplikace](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "publikování aplikace")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-623">![Publishing the Application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "Publishing the Application")</span></span>

    <span data-ttu-id="1ee5b-624">*Publikování webu*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-624">*Publishing the web site*</span></span>
2. <span data-ttu-id="1ee5b-625">Umožňuje naimportujte profil publikování, který jste uložili v první úloze.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-625">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="1ee5b-626">![Import profilu publikování](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "import profilu publikování")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-626">![Importing the publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "Importing the publish profile")</span></span>

    <span data-ttu-id="1ee5b-627">*Import profilu publikování*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-627">*Importing publish profile*</span></span>
3. <span data-ttu-id="1ee5b-628">Klikněte na tlačítko **ověření připojení**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-628">Click **Validate Connection**.</span></span> <span data-ttu-id="1ee5b-629">Po dokončení ověření klikněte na tlačítko **Další**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-629">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="1ee5b-630">Ověření je hotová, jakmile se zobrazí zelené zaškrtnutí zobrazí vedle tlačítko ověřit připojení.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-630">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="1ee5b-631">![Ověření připojení](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "ověřování připojení")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-631">![Validating connection](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "Validating connection")</span></span>

    <span data-ttu-id="1ee5b-632">*Ověření připojení*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-632">*Validating connection*</span></span>
4. <span data-ttu-id="1ee5b-633">V **nastavení** v části **databáze** části, klikněte na tlačítko vedle připojení databáze textové pole (tj. **objekt DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="1ee5b-633">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="1ee5b-634">![Konfigurace nasazení webu](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "konfigurace nasazení webu")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-634">![Web deploy configuration](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web deploy configuration")</span></span>

    <span data-ttu-id="1ee5b-635">*Konfigurace nasazení webu*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-635">*Web deploy configuration*</span></span>
5. <span data-ttu-id="1ee5b-636">Připojení k databázi nakonfigurujte následujícím způsobem:</span><span class="sxs-lookup"><span data-stu-id="1ee5b-636">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="1ee5b-637">V **název serveru** zadejte vaše databáze SQL serveru adresu URL pomocí *tcp:* předponu.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-637">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="1ee5b-638">V **uživatelské jméno** zadejte vaše přihlašovací jméno správce serveru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-638">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="1ee5b-639">V **heslo** zadejte přihlašovací heslo správce serveru.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-639">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="1ee5b-640">Zadejte nový název databáze, například: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-640">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="1ee5b-641">![Konfigurace cílový připojovací řetězec](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "konfigurace cílový připojovací řetězec")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-641">![Configuring destination connection string](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="1ee5b-642">*Konfigurace cílový připojovací řetězec*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-642">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="1ee5b-643">Pak klikněte na tlačítko **OK**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-643">Then click **OK**.</span></span> <span data-ttu-id="1ee5b-644">Po zobrazení výzvy k vytvoření databáze, klikněte na tlačítko **Ano**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-644">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="1ee5b-645">![Vytvoření databáze](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "vytváření řetězec databáze")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-645">![Creating the database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "Creating the database string")</span></span>

    <span data-ttu-id="1ee5b-646">*Vytvoření databáze*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-646">*Creating the database*</span></span>
7. <span data-ttu-id="1ee5b-647">Připojovací řetězec, který budete používat pro připojení k databázi SQL v systému Windows Azure je uvedené v rámci textbox výchozí připojení.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-647">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="1ee5b-648">Pak klikněte na tlačítko **Další**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-648">Then click **Next**.</span></span>

    <span data-ttu-id="1ee5b-649">![Připojovací řetězec odkazující na databázi SQL](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "připojovací řetězec odkazující na databázi SQL")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-649">![Connection string pointing to SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="1ee5b-650">*Připojovací řetězec odkazující na databázi SQL*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-650">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="1ee5b-651">V **Preview** klikněte na tlačítko **publikovat**.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-651">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="1ee5b-652">![Publikování webové aplikace](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "publikování webové aplikace")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-652">![Publishing the web application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "Publishing the web application")</span></span>

    <span data-ttu-id="1ee5b-653">*Publikování webové aplikace*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-653">*Publishing the web application*</span></span>
9. <span data-ttu-id="1ee5b-654">Jakmile proces publikování dokončí, otevře se výchozí prohlížeč publikované webové stránky.</span><span class="sxs-lookup"><span data-stu-id="1ee5b-654">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="1ee5b-655">![Aplikace publikována do služby Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "aplikace publikována do služby Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="1ee5b-655">![Application published to Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="1ee5b-656">*Aplikace, které jsou publikovány do služby Windows Azure*</span><span class="sxs-lookup"><span data-stu-id="1ee5b-656">*Application published to Windows Azure*</span></span>
