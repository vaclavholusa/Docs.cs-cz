...
## <a name="improvements-in-the-code-behind-model"></a><span data-ttu-id="4451a-112">Vylepšení v modelu kódu</span><span class="sxs-lookup"><span data-stu-id="4451a-112">Improvements in the Code-Behind Model</span></span>
...
## <a name="compilationmode"></a><span data-ttu-id="4451a-153">Vlastnost CompilationMode</span><span class="sxs-lookup"><span data-stu-id="4451a-153">CompilationMode</span></span>
...
## <a name="theme"></a><span data-ttu-id="4451a-184">Motiv</span><span class="sxs-lookup"><span data-stu-id="4451a-184">Theme</span></span>
...
## <a name="form"></a><span data-ttu-id="4451a-224">Formulář</span><span class="sxs-lookup"><span data-stu-id="4451a-224">Form</span></span>
...
## <a name="iscrosspagepostback"></a><span data-ttu-id="4451a-238">IsCrossPagePostBack</span><span class="sxs-lookup"><span data-stu-id="4451a-238">IsCrossPagePostBack</span></span>
...
<span data-ttu-id="4451a-263">Tato vlastnost získá nebo nastaví šablony stylů, která se uplatňuje na stránku.</span><span class="sxs-lookup"><span data-stu-id="4451a-263">This property gets or sets the style sheet that is applied to a page.</span></span>
...
## <a name="adapter"></a><span data-ttu-id="4451a-276">Adaptér</span><span class="sxs-lookup"><span data-stu-id="4451a-276">Adapter</span></span>
...
## <a name="new-public-methods-for-the-page-class"></a><span data-ttu-id="4451a-290">Nové veřejné metody pro třídu stránky</span><span class="sxs-lookup"><span data-stu-id="4451a-290">New Public Methods for the Page Class</span></span>
...
## <a name="preload-new-in-20"></a><span data-ttu-id="4451a-328">Předběžné načtení (nově ve verzi 2.0)</span><span class="sxs-lookup"><span data-stu-id="4451a-328">PreLoad (New in 2.0)</span></span>
...
## <a name="savestatecomplete-new-in-20"></a><span data-ttu-id="4451a-340">SaveStateComplete (nově ve verzi 2.0)</span><span class="sxs-lookup"><span data-stu-id="4451a-340">SaveStateComplete (New in 2.0)</span></span>
...
<span data-ttu-id="4451a-355">Následující video je návod, zpětné volání mezi stránkami.</span><span class="sxs-lookup"><span data-stu-id="4451a-355">The video below is a walkthrough of a cross-page postback.</span></span>
...
## <a name="step-3--hook-the-client-side-control-event"></a><span data-ttu-id="4451a-446">Krok 3: Připojení událostí ovládacího prvku na straně klienta</span><span class="sxs-lookup"><span data-stu-id="4451a-446">Step 3 : Hook the Client-Side Control Event</span></span>
...
<span data-ttu-id="4451a-451">Vzpomeňte si, že *cbRef* je návratová hodnota z volání GetCallbackEventReference.</span><span class="sxs-lookup"><span data-stu-id="4451a-451">Recall that *cbRef* is the return value from the call to GetCallbackEventReference.</span></span> <span data-ttu-id="4451a-452">Obsahuje volání do webového formuláře\_DoCallback zobrazená výše.</span><span class="sxs-lookup"><span data-stu-id="4451a-452">It contains the call to WebForm\_DoCallback that was shown above.</span></span>

## <a name="step-4--register-the-client-side-script"></a><span data-ttu-id="4451a-453">Krok 4: Registrace skriptu na straně klienta</span><span class="sxs-lookup"><span data-stu-id="4451a-453">Step 4 : Register the Client-Side Script</span></span>

<span data-ttu-id="4451a-454">Vzpomínáte, který volání GetCallbackEventReference zadán, skript na straně klienta volána **ShowCompanyName** by byl proveden po úspěšném zpětného volání na straně serveru.</span><span class="sxs-lookup"><span data-stu-id="4451a-454">Recall that the call to GetCallbackEventReference specified that a client-side script called **ShowCompanyName** would be executed when the server-side callback succeeds.</span></span> <span data-ttu-id="4451a-455">Tento skript je potřeba přidat na stránku pro použití ClientScriptManager instance.</span><span class="sxs-lookup"><span data-stu-id="4451a-455">That script needs to be added to the page using a ClientScriptManager instance.</span></span> <span data-ttu-id="4451a-456">(Třída ClientScriptManager bude dicussed později v tomto modulu.) To provedete jako v tomto:</span><span class="sxs-lookup"><span data-stu-id="4451a-456">(The ClientScriptManager class will be dicussed later in this module.) You do that like so:</span></span>

[!code-javascript[Main](the-asp-net-2-0-page-model/samples/sample16.js)]

## <a name="step-5--call-the-methods-of-the-icallbackeventhandler-interface"></a><span data-ttu-id="4451a-457">Krok 5: Volání metody rozhraní ICallbackEventHandler</span><span class="sxs-lookup"><span data-stu-id="4451a-457">Step 5 : Call the Methods of the ICallbackEventHandler Interface</span></span>

<span data-ttu-id="4451a-458">Rozhraní ICallbackEventHandler obsahuje dvě metody, které je nutné implementovat v kódu.</span><span class="sxs-lookup"><span data-stu-id="4451a-458">The ICallbackEventHandler contains two methods that you need to implement in your code.</span></span> <span data-ttu-id="4451a-459">Jsou **RaiseCallbackEvent** a **GetCallbackEvent**.</span><span class="sxs-lookup"><span data-stu-id="4451a-459">They are **RaiseCallbackEvent** and **GetCallbackEvent**.</span></span>

<span data-ttu-id="4451a-460">**RaiseCallbackEvent** přijímá řetězec jako argument a vrátí hodnotu nothing.</span><span class="sxs-lookup"><span data-stu-id="4451a-460">**RaiseCallbackEvent** takes a string as an argument and returns nothing.</span></span> <span data-ttu-id="4451a-461">Řetězcový argument je předán z volání na straně klienta webového formuláře\_DoCallback.</span><span class="sxs-lookup"><span data-stu-id="4451a-461">The string argument is passed from the client-side call to WebForm\_DoCallback.</span></span> <span data-ttu-id="4451a-462">V takovém případě je tato hodnota *hodnotu* atribut volá ddlCompany rozevíracího seznamu.</span><span class="sxs-lookup"><span data-stu-id="4451a-462">In this case, that value is the *value* attribute of the dropdown called ddlCompany.</span></span> <span data-ttu-id="4451a-463">Váš kód na straně serveru musí být umístěné ve RaiseCallbackEvent metody.</span><span class="sxs-lookup"><span data-stu-id="4451a-463">Your server-side code should be placed in the RaiseCallbackEvent method.</span></span> <span data-ttu-id="4451a-464">Například pokud je vaše zpětné volání žádosti WebRequest proti externímu prostředku, tento kód musí být umístěné ve RaiseCallbackEvent.</span><span class="sxs-lookup"><span data-stu-id="4451a-464">For example, if your callback is making a WebRequest against an external resource, that code should be placed in RaiseCallbackEvent.</span></span>

<span data-ttu-id="4451a-465">**GetCallbackEvent** je zodpovědná za zpracování vrácení zpětné volání do klienta.</span><span class="sxs-lookup"><span data-stu-id="4451a-465">**GetCallbackEvent** is responsible for processing the return of the callback to the client.</span></span> <span data-ttu-id="4451a-466">Nepřijímá žádné argumenty a vrátí hodnotu typu string.</span><span class="sxs-lookup"><span data-stu-id="4451a-466">It takes no arguments and returns a string.</span></span> <span data-ttu-id="4451a-467">Řetězec, který vrátí se předá jako argument pro funkci na straně klienta v tomto případě *ShowCompanyName*.</span><span class="sxs-lookup"><span data-stu-id="4451a-467">The string that it returns will be passed as an argument to the client-side function, in this case *ShowCompanyName*.</span></span>

<span data-ttu-id="4451a-468">Po dokončení výše uvedené kroky, jste připraveni k provádění zpětného volání skriptu v ASP.NET 2.0.</span><span class="sxs-lookup"><span data-stu-id="4451a-468">Once you have completed the above steps, you are ready to perform a script callback in ASP.NET 2.0.</span></span>


![](the-asp-net-2-0-page-model/_static/image4.png)


[<span data-ttu-id="4451a-469">Otevřít Video na celou obrazovku</span><span class="sxs-lookup"><span data-stu-id="4451a-469">Open Full-Screen Video</span></span>](the-asp-net-2-0-page-model/_static/callback1.wmv)


<span data-ttu-id="4451a-470">Zpětná volání skriptu v ASP.NET jsou podporovány v jakémkoli prohlížeči, který podporuje provedete XMLHttp volání.</span><span class="sxs-lookup"><span data-stu-id="4451a-470">Script callbacks in ASP.NET are supported in any browser that supports making XMLHttp calls.</span></span> <span data-ttu-id="4451a-471">To zahrnuje všechny moderní prohlížeče používá ještě dnes.</span><span class="sxs-lookup"><span data-stu-id="4451a-471">That includes all of the modern browsers in use today.</span></span> <span data-ttu-id="4451a-472">Aplikace Internet Explorer používá objektu XMLHttp ActiveX při použití vnitřního objektu XMLHttp dalších moderních prohlížečů (včetně nadcházející aplikace Internet Explorer 7).</span><span class="sxs-lookup"><span data-stu-id="4451a-472">Internet Explorer uses the XMLHttp ActiveX object while other modern browsers (including the upcoming IE 7) use an intrinsic XMLHttp object.</span></span> <span data-ttu-id="4451a-473">K určení prostřednictvím kódu programu, pokud je prohlížeč podporuje zpětná volání, můžete použít **Request.Browser.SupportCallback** vlastnost.</span><span class="sxs-lookup"><span data-stu-id="4451a-473">To programmatically determine if a browser supports callbacks, you can use the **Request.Browser.SupportCallback** property.</span></span> <span data-ttu-id="4451a-474">Tato vlastnost vrátí **true** Pokud klienta, který podporuje zpětná volání skriptu.</span><span class="sxs-lookup"><span data-stu-id="4451a-474">This property will return **true** if the requesting client supports script callbacks.</span></span>

## <a name="working-with-client-script-in-aspnet-20"></a><span data-ttu-id="4451a-475">Práce s klientským skriptem v technologii ASP.NET 2.0</span><span class="sxs-lookup"><span data-stu-id="4451a-475">Working with Client Script in ASP.NET 2.0</span></span>

<span data-ttu-id="4451a-476">Skripty klienta v technologii ASP.NET 2.0 jsou spravované prostřednictvím použití třídy ClientScriptManager.</span><span class="sxs-lookup"><span data-stu-id="4451a-476">Client scripts in ASP.NET 2.0 are managed via the use of the ClientScriptManager class.</span></span> <span data-ttu-id="4451a-477">Třída ClientScriptManager uchovává informace o klientských skriptů pomocí typu a název.</span><span class="sxs-lookup"><span data-stu-id="4451a-477">The ClientScriptManager class keeps track of client scripts using a type and a name.</span></span> <span data-ttu-id="4451a-478">Díky tomu stejný skript programově vloženého na stránce více než jednou.</span><span class="sxs-lookup"><span data-stu-id="4451a-478">This prevents the same script from being programmatically inserted on a page more than once.</span></span>

> [!NOTE]
> <span data-ttu-id="4451a-479">Skript po úspěšné registraci na stránce, jakékoli následné pokusy o registraci stejný skript jednoduše výsledkem skriptu není zaregistrovaný podruhé.</span><span class="sxs-lookup"><span data-stu-id="4451a-479">After a script has been successfully registered on a page, any subsequent attempt to register the same script will simply result in the script not being registered a second time.</span></span> <span data-ttu-id="4451a-480">Budou přidány žádné duplicitní skripty a dojde k žádné výjimce.</span><span class="sxs-lookup"><span data-stu-id="4451a-480">No duplicate scripts are added and no exception occurs.</span></span> <span data-ttu-id="4451a-481">Aby se zabránilo zbytečným výpočtu, jsou metody, které můžete použít k určení, jestli skript je už zaregistrovaný, takže není pokusí zaregistrovat víc než jednou.</span><span class="sxs-lookup"><span data-stu-id="4451a-481">To avoid unnecessary computation, there are methods that you can use to determine if a script is already registered so that you do not attempt to register it more than once.</span></span>


<span data-ttu-id="4451a-482">Metody ClientScriptManager by měl být všechny aktuální vývojáře využívající technologii ASP.NET:</span><span class="sxs-lookup"><span data-stu-id="4451a-482">The methods of the ClientScriptManager should be familiar to all current ASP.NET developers:</span></span>

## <a name="registerclientscriptblock"></a><span data-ttu-id="4451a-483">RegisterClientScriptBlock</span><span class="sxs-lookup"><span data-stu-id="4451a-483">RegisterClientScriptBlock</span></span>

<span data-ttu-id="4451a-484">Tato metoda přidá do horní části na vykreslené stránce skriptu.</span><span class="sxs-lookup"><span data-stu-id="4451a-484">This method adds a script to the top of the rendered page.</span></span> <span data-ttu-id="4451a-485">To je užitečné pro přidávání funkcí, které se explicitně volat na straně klienta.</span><span class="sxs-lookup"><span data-stu-id="4451a-485">This is useful for adding functions that will be explicitly called on the client.</span></span>

<span data-ttu-id="4451a-486">Existují dvě přetížené verze této metody.</span><span class="sxs-lookup"><span data-stu-id="4451a-486">There are two overloaded versions of this method.</span></span> <span data-ttu-id="4451a-487">Tři ze čtyř argumentů jsou běžné mezi nimi.</span><span class="sxs-lookup"><span data-stu-id="4451a-487">Three of four arguments are common among them.</span></span> <span data-ttu-id="4451a-488">Možnosti jsou následující:</span><span class="sxs-lookup"><span data-stu-id="4451a-488">They are:</span></span>

`type (string)`

<span data-ttu-id="4451a-489">***Typ*** argument určuje typ skriptu.</span><span class="sxs-lookup"><span data-stu-id="4451a-489">The ***type*** argument identifies a type for the script.</span></span> <span data-ttu-id="4451a-490">Obecně je vhodné použít typ stránky (this. GetType()) typu.</span><span class="sxs-lookup"><span data-stu-id="4451a-490">It is generally a good idea to use the page's type (this.GetType()) for the type.</span></span>

`key (string)`

<span data-ttu-id="4451a-491">***Klíč*** argument je uživatelský klíč pro skript.</span><span class="sxs-lookup"><span data-stu-id="4451a-491">The ***key*** argument is a user-defined key for the script.</span></span> <span data-ttu-id="4451a-492">To by měl být jedinečný pro každý skript.</span><span class="sxs-lookup"><span data-stu-id="4451a-492">This should be unique for each script.</span></span> <span data-ttu-id="4451a-493">Pokud se pokusíte přidat skript se stejným klíčem a typ již přidané skriptu, nebude přidán.</span><span class="sxs-lookup"><span data-stu-id="4451a-493">If you attempt to add a script with the same key and type of an already added script, it will not be added.</span></span>

`script (string)`

<span data-ttu-id="4451a-494">***Skript*** argument je řetězec obsahující skutečné skript pro přidání.</span><span class="sxs-lookup"><span data-stu-id="4451a-494">The ***script*** argument is a string containing the actual script to add.</span></span> <span data-ttu-id="4451a-495">Je doporučeno použít StringBuilder vytvořit skript a pak použijte metodu ToString() ve třídě StringBuilder nebyla přiřadit ***skript*** argument.</span><span class="sxs-lookup"><span data-stu-id="4451a-495">It's recommended that you use a StringBuilder to create the script and then use the ToString() method on the StringBuilder to assign the ***script*** argument.</span></span>

<span data-ttu-id="4451a-496">Pokud používáte přetížené RegisterClientScriptBlock, který zabere jenom tři argumenty, musí obsahovat prvky skriptu (&lt;skript&gt; a &lt;/script&gt;) ve vašem skriptu.</span><span class="sxs-lookup"><span data-stu-id="4451a-496">If you use the overloaded RegisterClientScriptBlock that only takes three arguments, you must include script elements (&lt;script&gt; and &lt;/script&gt;) in your script.</span></span>

<span data-ttu-id="4451a-497">Můžete použít přetížení RegisterClientScriptBlock, která přijímá čtvrtý argument.</span><span class="sxs-lookup"><span data-stu-id="4451a-497">You may choose to use the overload of RegisterClientScriptBlock that takes a fourth argument.</span></span> <span data-ttu-id="4451a-498">Čtvrtý argument je logická hodnota, která určuje, zda technologie ASP.NET přidala prvky skriptu za vás.</span><span class="sxs-lookup"><span data-stu-id="4451a-498">The fourth argument is a Boolean that specifies whether or not ASP.NET should add script elements for you.</span></span> <span data-ttu-id="4451a-499">Pokud je tento argument **true**, váš skript by neměla obsahovat prvky skriptu explicitně.</span><span class="sxs-lookup"><span data-stu-id="4451a-499">If this argument is **true**, your script should not include the script elements explicitly.</span></span>

<span data-ttu-id="4451a-500">Pomocí této metody IsClientScriptBlockRegistered určit, jestli je skript už zaregistrovaný.</span><span class="sxs-lookup"><span data-stu-id="4451a-500">Use the IsClientScriptBlockRegistered method to determine if a script has already been registered.</span></span> <span data-ttu-id="4451a-501">To umožňuje vyhnout se znovu zaregistrovat skript, který už je zaregistrovaný.</span><span class="sxs-lookup"><span data-stu-id="4451a-501">This allows you to avoid an attempt to re-register a script that has already been registered.</span></span>

### <a name="registerclientscriptinclude-new-in-20"></a><span data-ttu-id="4451a-502">RegisterClientScriptInclude (nově ve verzi 2.0)</span><span class="sxs-lookup"><span data-stu-id="4451a-502">RegisterClientScriptInclude (New in 2.0)</span></span>

<span data-ttu-id="4451a-503">Značka RegisterClientScriptInclude vytvoří blok skriptu odkazující na externí soubor skriptu.</span><span class="sxs-lookup"><span data-stu-id="4451a-503">The RegisterClientScriptInclude tag creates a script block that links to an external script file.</span></span> <span data-ttu-id="4451a-504">Má dvě přetížení.</span><span class="sxs-lookup"><span data-stu-id="4451a-504">It has two overloads.</span></span> <span data-ttu-id="4451a-505">Přijímá jeden klíč a adresu URL.</span><span class="sxs-lookup"><span data-stu-id="4451a-505">One takes a key and a URL.</span></span> <span data-ttu-id="4451a-506">Druhá přidá třetí argument určující typ.</span><span class="sxs-lookup"><span data-stu-id="4451a-506">The second adds a third argument specifying the type.</span></span>

<span data-ttu-id="4451a-507">Následující kód například vygeneruje blok skriptu, který odkazuje na jsfunctions.js v kořenové složce skriptů aplikace:</span><span class="sxs-lookup"><span data-stu-id="4451a-507">For example, the following code generates a script block that links to jsfunctions.js in the root of the scripts folder of the application:</span></span>

[!code-csharp[Main](the-asp-net-2-0-page-model/samples/sample17.cs)]

<span data-ttu-id="4451a-508">Tento kód vytvoří následující kód na vykreslené stránce:</span><span class="sxs-lookup"><span data-stu-id="4451a-508">This code produces the following code in the rendered page:</span></span>

[!code-html[Main](the-asp-net-2-0-page-model/samples/sample18.html)]

> [!NOTE]
> <span data-ttu-id="4451a-509">Blok skriptu se vykreslí v dolní části stránky.</span><span class="sxs-lookup"><span data-stu-id="4451a-509">The script block is rendered at the bottom of the page.</span></span>


<span data-ttu-id="4451a-510">Pomocí této metody IsClientScriptIncludeRegistered určit, jestli je skript už zaregistrovaný.</span><span class="sxs-lookup"><span data-stu-id="4451a-510">Use the IsClientScriptIncludeRegistered method to determine if a script has already been registered.</span></span> <span data-ttu-id="4451a-511">To umožňuje vyhnout se znovu zaregistrovat skript.</span><span class="sxs-lookup"><span data-stu-id="4451a-511">This allows you to avoid an attempt to re-register a script.</span></span>

## <a name="registerstartupscript"></a><span data-ttu-id="4451a-512">RegisterStartupScript</span><span class="sxs-lookup"><span data-stu-id="4451a-512">RegisterStartupScript</span></span>

<span data-ttu-id="4451a-513">Metoda RegisterStartupScript používá stejné argumenty jako metodu RegisterClientScriptBlock.</span><span class="sxs-lookup"><span data-stu-id="4451a-513">The RegisterStartupScript method takes the same arguments as the RegisterClientScriptBlock method.</span></span> <span data-ttu-id="4451a-514">Skript zaregistrovaného RegisterStartupScript provádí po načtení stránky, ale před událostí načtení na straně klienta.</span><span class="sxs-lookup"><span data-stu-id="4451a-514">A script registered with RegisterStartupScript executes after the page loads but before the OnLoad client-side event.</span></span> <span data-ttu-id="4451a-515">V 1.X, skripty, které jsou zaregistrované RegisterStartupScript zadal těsně před uzavírací &lt;/form&gt; označit při skripty zaregistrovaného RegisterClientScriptBlock byly umístěny ihned po otevření &lt;formuláře&gt; značky.</span><span class="sxs-lookup"><span data-stu-id="4451a-515">In 1.X, scripts registered with RegisterStartupScript were placed just before the closing &lt;/form&gt; tag while scripts registered with RegisterClientScriptBlock were placed immediately after the opening &lt;form&gt; tag.</span></span> <span data-ttu-id="4451a-516">V technologii ASP.NET 2.0, obě jsou umístěné bezprostředně před uzavírací &lt;/form&gt; značky.</span><span class="sxs-lookup"><span data-stu-id="4451a-516">In ASP.NET 2.0, both are placed immediately before the closing &lt;/form&gt; tag.</span></span>

> [!NOTE]
> <span data-ttu-id="4451a-517">Když si zaregistrujete funkce s RegisterStartupScript, tato funkce nebude spuštěno, dokud ho explicitně volat v kódu na straně klienta.</span><span class="sxs-lookup"><span data-stu-id="4451a-517">If you register a function with RegisterStartupScript, that function will not execute until you explicitly call it in client-side code.</span></span>


<span data-ttu-id="4451a-518">Pomocí metody IsStartupScriptRegistered můžete určit, jestli je skript už zaregistrovaný a vyhnout se znovu zaregistrovat skript.</span><span class="sxs-lookup"><span data-stu-id="4451a-518">Use the IsStartupScriptRegistered method to determine if a script has already been registered and avoid an attempt to re-register a script.</span></span>

## <a name="other-clientscriptmanager-methods"></a><span data-ttu-id="4451a-519">Jiné metody ClientScriptManager</span><span class="sxs-lookup"><span data-stu-id="4451a-519">Other ClientScriptManager Methods</span></span>

<span data-ttu-id="4451a-520">Tady jsou některé z dalších užitečných metod ClientScriptManager třídy.</span><span class="sxs-lookup"><span data-stu-id="4451a-520">Here are some of the other useful methods of the ClientScriptManager class.</span></span>


|  <span data-ttu-id="4451a-521"><strong>GetCallbackEventReference</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-521"><strong>GetCallbackEventReference</strong></span></span>   |                                                 <span data-ttu-id="4451a-522">Viz zpětná volání skriptu dříve v tomto modulu.</span><span class="sxs-lookup"><span data-stu-id="4451a-522">See script callbacks earlier in this module.</span></span>                                                 |
|-----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
|  <span data-ttu-id="4451a-523"><strong>GetPostBackClientHyperlink</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-523"><strong>GetPostBackClientHyperlink</strong></span></span>  |                <span data-ttu-id="4451a-524">Získá odkaz JavaScript (jazyk javascript:&lt;volání&gt;), který je možné publikovat zpět z události na straně klienta.</span><span class="sxs-lookup"><span data-stu-id="4451a-524">Gets a JavaScript reference (javascript:&lt;call&gt;) that can be used to post back from a client-side event.</span></span>                 |
|  <span data-ttu-id="4451a-525"><strong>GetPostBackEventReference</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-525"><strong>GetPostBackEventReference</strong></span></span>   |                                   <span data-ttu-id="4451a-526">Získá řetězec, který slouží k zahájení příspěvek zpět od klienta.</span><span class="sxs-lookup"><span data-stu-id="4451a-526">Gets a string that can be used to initiate a post back from the client.</span></span>                                    |
|      <span data-ttu-id="4451a-527"><strong>GetWebResourceUrl</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-527"><strong>GetWebResourceUrl</strong></span></span>       | <span data-ttu-id="4451a-528">Vrátí adresu URL k prostředku, který je vložen do sestavení.</span><span class="sxs-lookup"><span data-stu-id="4451a-528">Returns a URL to a resource that is embedded in an assembly.</span></span> <span data-ttu-id="4451a-529">Je potřeba použít ve spojení s <strong>RegisterClientScriptResource</strong>.</span><span class="sxs-lookup"><span data-stu-id="4451a-529">Must be used in conjunction with <strong>RegisterClientScriptResource</strong>.</span></span> |
| <span data-ttu-id="4451a-530"><strong>RegisterClientScriptResource</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-530"><strong>RegisterClientScriptResource</strong></span></span> |     <span data-ttu-id="4451a-531">Zaregistruje prostředek webové stránky.</span><span class="sxs-lookup"><span data-stu-id="4451a-531">Registers a Web resource with the page.</span></span> <span data-ttu-id="4451a-532">Toto jsou prostředky součástí sestavení a zpracovat nová obslužná rutina WebResource.axd.</span><span class="sxs-lookup"><span data-stu-id="4451a-532">These are resources embedded in an assembly and handled by the new WebResource.axd handler.</span></span>      |
|     <span data-ttu-id="4451a-533"><strong>RegisterHiddenField</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-533"><strong>RegisterHiddenField</strong></span></span>      |                                                 <span data-ttu-id="4451a-534">Zaregistruje skryté pole formuláře se stránkou.</span><span class="sxs-lookup"><span data-stu-id="4451a-534">Registers a hidden form field with the page.</span></span>                                                 |
|  <span data-ttu-id="4451a-535"><strong>RegisterOnSubmitStatement</strong></span><span class="sxs-lookup"><span data-stu-id="4451a-535"><strong>RegisterOnSubmitStatement</strong></span></span>   |                                  <span data-ttu-id="4451a-536">Zaregistruje kód na straně klienta, který se spustí, když se odešle formulář HTML.</span><span class="sxs-lookup"><span data-stu-id="4451a-536">Registers client-side code that executes when the HTML form is submitted.</span></span>                                   |
