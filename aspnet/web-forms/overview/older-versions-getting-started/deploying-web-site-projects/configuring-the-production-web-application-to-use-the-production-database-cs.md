...
---
<a name="configuring-the-production-web-application-to-use-the-production-database-c"></a>Konfigurace provozní webové aplikace pro použití provozní databáze (C#)
====================
...
**Obrázek 3**: The Data-Driven aplikace je nyní k dispozici v produkčním prostředí. ([Kliknutím ji zobrazíte obrázek v plné velikosti](configuring-the-production-web-application-to-use-the-production-database-cs/_static/image9.jpg))
...
**Obrázek 4**: ConfigSections ([kliknutím ji zobrazíte obrázek v plné velikosti](configuring-the-production-web-application-to-use-the-production-database-cs/_static/image12.jpg))
