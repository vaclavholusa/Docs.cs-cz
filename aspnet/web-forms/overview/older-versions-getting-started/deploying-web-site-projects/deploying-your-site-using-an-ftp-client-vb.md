...
**Obrázek 2**: kontrol lokality adresáře je nyní dostupný všem uživatelům s připojením k Internetu ([kliknutím ji zobrazíte obrázek v plné velikosti](deploying-your-site-using-an-ftp-client-vb/_static/image6.png))
