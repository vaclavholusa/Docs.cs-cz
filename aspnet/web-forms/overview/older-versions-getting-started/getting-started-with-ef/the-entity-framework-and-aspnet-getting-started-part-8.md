...
- [Rozhraní Entity Framework v knihovně MSDN](https://msdn.microsoft.com/en-us/library/bb399572.aspx)
- [Rozhraní Entity Framework v Centru pro vývojáře MSDN dat](https://msdn.microsoft.com/en-us/data/ef.aspx)
- [Přehled ovládacího prvku EntityDataSource webového serveru v knihovně MSDN](https://msdn.microsoft.com/en-us/library/cc488502.aspx)
- [Ovládací prvek EntityDataSource referenční dokumentace rozhraní API v knihovně MSDN](https://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.entitydatasource.aspx)
- [Fóra Entity Framework na webu MSDN](https://social.msdn.microsoft.com/forums/en-US/adodotnetentityframework/)
