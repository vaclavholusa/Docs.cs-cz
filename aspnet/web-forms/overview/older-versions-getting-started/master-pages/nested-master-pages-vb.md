...
[Stáhněte si kód](http://download.microsoft.com/download/d/6/6/d66ad554-afdd-409e-a5c3-201b774fbb31/ASPNET_MasterPages_Tutorial_10_VB.zip) nebo [stáhnout PDF](http://download.microsoft.com/download/d/6/6/d66ad554-afdd-409e-a5c3-201b774fbb31/ASPNET_MasterPages_Tutorial_10_VB.pdf)
...
[![Vnořené stránky předlohy definuje obsahu specifické pro stránky v části Správa](nested-master-pages-vb/_static/image2.png)](nested-master-pages-vb/_static/image1.png)

**Obrázek 01**: vnořené hlavní stránky definuje obsahu specifické pro stránky v části Správa ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image3.png))
...
[![Zkontrolujte &quot;vyberte stránku předlohy&quot; zaškrtávací políčko k přidání vnořené hlavní stránky](nested-master-pages-vb/_static/image5.png)](nested-master-pages-vb/_static/image4.png)

**Obrázek 02**: Zaškrtnutím políčka "Vyberte stránku předlohy" Přidání vnořené hlavní stránky ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image6.png))


[![Vytvoření vazby vnořené hlavní stránky na stránku předlohy Simple.master](nested-master-pages-vb/_static/image8.png)](nested-master-pages-vb/_static/image7.png)

**Obrázek 03**: vytvoření vazby vnořené hlavní stránky `Simple.master` – stránka předlohy ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image9.png))
...
**Obrázek 04**: nové obsahu stránce obsahuje Ne ovládací prvky obsahu ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image12.png))
...
[![Nejvyšší úrovně a vnořené hlavní stránky, určují rozložení obsahu stránky](nested-master-pages-vb/_static/image14.png)](nested-master-pages-vb/_static/image13.png)

**Obrázek 05**: nejvyšší úrovně a vnořené hlavní stránky, určují rozložení obsahu stránce ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image15.png))
...
[![Obsahu stránce nyní zahrnuje ovládací prvky obsahu pro ContentPlaceHolders vnořené stránky předlohy](nested-master-pages-vb/_static/image17.png)](nested-master-pages-vb/_static/image16.png)

**Obrázek 06**: obsahu stránce nyní zahrnuje ovládací prvky obsahu pro vnořené hlavní stránky ContentPlaceHolders ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image18.png))
...
[![Alternate.aspx je vázána na stránku předlohy SimpleNestedAlternate.master](nested-master-pages-vb/_static/image20.png)](nested-master-pages-vb/_static/image19.png)

**Obrázek 07**: `Alternate.aspx` je vázána `SimpleNestedAlternate.master` – stránka předlohy ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image21.png))
...
[![Změnit na hlavní stránku nejvyšší úrovně se okamžitě projeví v jeho vnořené hlavní stránky a jejich stránky obsahu](nested-master-pages-vb/_static/image23.png)](nested-master-pages-vb/_static/image22.png)

**Obrázek 08**: změnit na hlavní stránku nejvyšší úrovně se okamžitě projeví v jeho vnořené hlavní stránky a jejich stránky obsahu ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image24.png))
...
Naše první krokem je vytvoření vnořené hlavní stránky má být používána stránky v části Správa. Jak jsme viděli v kroku 2, při přidání nového vnořené hlavní stránky, je potřeba zadat vnořené hlavní stránky nadřazená stránka předlohy. Dva hlavní stránky nejvyšší úrovně, ale: `Site.master` a `Alternate.master`. Odvolání, který jsme vytvořili `Alternate.master` v předchozí kurzu a napsali v kódu `BasePage` třídy dané sadě `Page` objektu `MasterPageFile` vlastnost za běhu, aby buď `Site.master` nebo `Alternate.master` v závislosti na hodnotě `MyMasterPage` Proměnné relace.
...
[![Přidejte do složky ~/Admin vnořené stránky předlohy.](nested-master-pages-vb/_static/image26.png)](nested-master-pages-vb/_static/image25.png)

**Obrázek 09**: přidejte vnořené hlavní stránky `~/Admin` složky. ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image27.png))
...
[![Vnořené stránky předlohy rozšiřuje nejvyšší úrovně stránky předlohy zahrnout pokyny pro správce.](nested-master-pages-vb/_static/image29.png)](nested-master-pages-vb/_static/image28.png)

**Obrázek 10**: vnořené stránky předlohy rozšiřuje nejvyšší úrovně stránky předlohy zahrnout pokyny pro správce. ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image30.png))
...
[![Vnořené stránky předlohy definuje obsahu specifické pro stránky v části Správa](nested-master-pages-vb/_static/image32.png)](nested-master-pages-vb/_static/image31.png)

**Obrázek 11**: vnořené hlavní stránky definuje obsahu specifické pro stránky v části Správa ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image33.png))
...
[![Obsahu stránky v části Správa obsahují pokyny v horní části každé stránce](nested-master-pages-vb/_static/image35.png)](nested-master-pages-vb/_static/image34.png)

**Obrázek 12**: obsahu stránky v pokyny zahrnují správu část v horní části každé stránky ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image36.png))
...
[![Stránka vnořené správy používá nejvyšší úrovně stránky předlohy vybrané uživatelem.](nested-master-pages-vb/_static/image38.png)](nested-master-pages-vb/_static/image37.png)

**Obrázek 13**: stránka Správa vnořené používá nejvyšší úrovně hlavní stránky vybraný uživatelem ([Kliknutím zobrazit obrázek v plné velikosti](nested-master-pages-vb/_static/image39.png))
