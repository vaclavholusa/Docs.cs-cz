...
**Obrázek 2**: Pokud je zadané neplatné uživatelské jméno, zobrazí se chybová zpráva ([kliknutím ji zobrazíte obrázek v plné velikosti](recovering-and-changing-passwords-cs/_static/image6.png))
...
**Obrázek 4**: uživatele se odešle E-mail s jeho nové heslo ([kliknutím ji zobrazíte obrázek v plné velikosti](recovering-and-changing-passwords-cs/_static/image12.png))
...
**Obrázek 5**: The předmět, text a kopie byl aktualizován seznam ([kliknutím ji zobrazíte obrázek v plné velikosti](recovering-and-changing-passwords-cs/_static/image15.png))
...
- Neuzamčení uživatele nelze resetovat své heslo. Nicméně může neschválených uživatele. Jsme se popisují uzamčeném navýšení kapacity a schválení stavy podrobněji <a id="_msoanchor_3"> </a> [ *Unlocking a schvalování uživatelských* ](unlocking-and-approving-user-accounts-cs.md) kurzu účty.
...
**Obrázek 8**: e-mailová zpráva informuje uživatele, že jejich heslo změněno ([kliknutím ji zobrazíte obrázek v plné velikosti](recovering-and-changing-passwords-cs/_static/image24.png))
