...
title: Vytvoření schématu členství v SQL serveru (C#) | Dokumentace Microsoftu
...
**Obrázek 1**: přidejte nový název databáze SQL `SecurityTutorials.mdf` databáze `App_Data` složky ([kliknutím ji zobrazíte obrázek v plné velikosti](creating-the-membership-schema-in-sql-server-cs/_static/image3.png))
...
**Obrázek 6**: databáze, kterou chcete přejmenovat `SecurityTutorialsDatabase`([kliknutím ji zobrazíte obrázek v plné velikosti](creating-the-membership-schema-in-sql-server-cs/_static/image18.png))
...
**Obrázek 7**: použijte ASP.NET SQL Server nastavení Průvodce provede přidání schématu členství ([kliknutím ji zobrazíte obrázek v plné velikosti](creating-the-membership-schema-in-sql-server-cs/_static/image21.png))
...
**Obrázek 10**: A různých tabulek, zobrazení a uložených procedur byly přidány do databáze ([kliknutím ji zobrazíte obrázek v plné velikosti](creating-the-membership-schema-in-sql-server-cs/_static/image30.png))
...
- [Vždycky nastavený `applicationName` vlastnost při konfiguraci technologie ASP.NET 2.0 členství a dalších poskytovatelů](https://weblogs.asp.net/scottgu/443634)
