...
> [!NOTE]
> `DirectoryInfo` a `FileInfo` třídy se nacházejí v [ `System.IO` obor názvů](https://msdn.microsoft.com/en-us/library/system.io.aspx). Proto bude buď potřeba adresa tyto názvy tříd s jejich názvy oborů názvů nebo obor názvů importovat soubor třídy (prostřednictvím `using System.IO`).
