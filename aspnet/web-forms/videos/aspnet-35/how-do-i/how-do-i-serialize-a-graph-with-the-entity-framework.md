...
---
<a name="how-do-i-serialize-a-graph-with-the-entity-framework"></a>[Jak na:] Serializovat graf s platformou Entity Framework
====================
podle [Brian Dawson](https://twitter.com/briandawson)

V této úvodní Brian Dawson video vám ukáže, jak k serializaci graf při vývoji aplikace ASP.NET ADO.NET Entity Framework.
