...
---
<a name="lesson-4-understanding-web-application-state"></a>[Lekce 4:] Stav Principy webové aplikace
====================
podle [Microsoft](https://github.com/microsoft)

V této lekci uvidíte, jak udržovat stav v technologii ASP.NET, včetně různých objektů, které můžete použít k uložení informací pro vaše aplikace ASP.NET 2.0.

[&#9654;Podívejte se na video (40 minutách)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/lesson-4-understanding-web-application-state)
