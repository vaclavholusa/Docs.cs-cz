...
---
<a name="login-controls"></a>Ovládací prvky pro přihlášení
====================
podle [Stagner Jan](https://github.com/JoeStagner)

V této Jan video vás seznámí s členství technologie ASP.NET ukazuje, jak používat některé z přihlašovacích ovládacích prvků technologie ASP.NET.
