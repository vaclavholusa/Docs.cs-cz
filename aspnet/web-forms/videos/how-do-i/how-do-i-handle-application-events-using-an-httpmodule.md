...
Naučte se vytvořit modul HTTP, která zpracovává události aplikace během zpracování požadavku na stránku. Ukázka modulu zapíše informace do souboru protokolu v různých fázích životního cyklu stránky. Také zjistit konfigurace modulu HTTP pro použití v ukázkového webu.
