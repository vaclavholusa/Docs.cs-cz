...
V této video PEL Jan zobrazí pro implementaci sledování získat podrobné informace o běhu pro aplikaci ASP.NET stavu. Další možnosti konfigurace výkonný a flexibilní pro sledování, včetně stavu události, neboli webové události, zprostředkovatele pro ukládání dat, pravidla pro mapování události na zprostředkovatele, sledování stavu profily pro často používaná nastavení a buffermode za účelem optimalizace stav monitorování pro nejlepší výkon. Pak najdete ukázkovou webovou aplikaci v akci s sledování stavu povoleno zápisu události do protokolu událostí systému Windows.
