...
---
<a name="how-do-i-precompile-an-aspnet-website"></a>[Jak na:] Předkompilovat webové stránky ASP.NET
====================
podle [PEL Jan](https://twitter.com/chrispels)

Jan PEL ukazuje, jak předkompilovat webu ASP.NET, což zvyšuje výkon při prvním spuštění a posiluje zabezpečení aplikací.
