...
<a name="chart"></a>Graf
====================
> Tato sada videa ukazuje, jak vytvořit vizuálně poutavé zobrazení dat pomocí ovládacího prvku grafu ASP.NET.


- [Graf – ovládací prvek](aspnet-4-quick-hit-chart-control.md)
- [Představujeme nové ovládací prvek grafu v sadě Visual Studio 2010](aspnet-4-how-do-i-introducing-the-new-chart-control-in-visual-studio-2010.md)
