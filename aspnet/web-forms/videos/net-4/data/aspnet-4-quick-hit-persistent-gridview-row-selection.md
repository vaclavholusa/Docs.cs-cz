...
---
<a name="aspnet-4-quick-hit--persistent-gridview-row-selection"></a>ASP.NET 4 "Rychlý zasáhnout" – výběr trvalé GridView řádku
====================
podle [Stagner Jan](https://github.com/JoeStagner)

V tomto videu se dozvíte o výběr trvalou řádků pro ovládací prvek GridView. 
