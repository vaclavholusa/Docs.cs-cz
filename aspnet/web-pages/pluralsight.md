...
---
<a name="webmatrix-and-web-pages-video-training-from-pluralsight"></a>Služba WebMatrix a webové stránky Video školení z Pluralsight
====================
...
- [Rozhraní ASP.NET Web Pages](https://pluralsight.com/training/Player?author=matt-milner&name=webmatrix-introduction-m5&mode=live&clip=0&course=webmatrix-introduction)
...
"Tento kurz, jež byly zaznamenány Matt Milner pro Pluralsight je skvělým způsobem, jak získat všechny podrobnosti, které je potřeba vytvořit dynamické datové aplikace používá technologii ASP.NET Web Pages, ale také výkonné Nová syntaxe Razor. Big Děkujeme k Pluralsight pro tento zdroj volné. Přehrávání videa, obsah a tok je skutečně dobře Hotovo. I doporučujeme, abyste ji rezervovat nyní!"
