...
# <a name="razor-pages-with-ef-core-in-aspnet-core---concurrency---8-of-8"></a>Stránky Razor s EF jádra ASP.NET Core - souběžnosti - 8 8
...
V tématu [dědičnosti](xref:data/ef-mvc/inheritance) o tom, jak dědit datový model.
