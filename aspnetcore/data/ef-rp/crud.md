...
Student/Home nebo jiné odkazy nefungují:

Ověřte stránky Razor obsahuje správný `@page` směrnice. Například by The Student/domovské stránky Razor **není** obsahovat šablonu trasy:
