...
Pomocí této na místě, všechny možnosti, které je potřeba spustit aplikaci ASP.NET pomocí tento vlastní server volat rozšíření v *Program.cs*:
...
Můžete vytvořit pomocí prostředí OWIN `HttpContext`.
