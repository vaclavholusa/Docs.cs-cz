<span data-ttu-id="76b2e-101">Přidejte následující vlastnosti pro `Movie` třídy:</span><span class="sxs-lookup"><span data-stu-id="76b2e-101">Add the following properties to the `Movie` class:</span></span>
