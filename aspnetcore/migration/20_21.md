...
Poskytuje ASP.NET Core 2.1 [ASP.NET Core Identity](xref:security/authentication/identity) jako [knihovny tříd Razor](xref:razor-pages/ui-class). Pokud jste neprovedli významné změny v šabloně 2.0 generovaného kódu Identity, zvažte následující postup upgradu:
