...
> [!TIP]
> Můžete přidat konvence pro vaše [middleware](xref:fundamentals/middleware) díky přístupu k `MvcOptions` pomocí`services.Configure<MvcOptions>(c => c.Conventions.Add(YOURCONVENTION));`
