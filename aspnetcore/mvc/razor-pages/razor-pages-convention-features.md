...
keywords: "ASP.NET Core, stránky Razor, konvence, AddFolderRouteModelConvention, AddPageRouteModelConvention, AddPageRoute, AddFolderApplicationModelConvention, AddPageApplicationModelConvention, ConfigureFilter, filtry"
ms.author: riande
manager: wpickett
ms.date: 10/23/2017
ms.topic: article
