...
Následující kód ukazuje, jak povolit kompresi middlewaru odpovědi s kompresi gzip výchozí a pro výchozí typy MIME.
...
| -------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| `CompressionLevel.Fastest`       | Komprese provést co nejrychleji, i když výsledný výstup není komprimována optimálně. |
...
## <a name="middlware-issue-when-behind-an-nginx-reverse-proxy"></a>Middlware problém při za zpětného proxy služby Nginx
