...
- **IQueryableUserStore**  
 [IQueryableUserStore&lt;TUser&gt; ](/dotnet/api/microsoft.aspnetcore.identity.iqueryableuserstore-1) rozhraní definuje členy implementace zajistit dotazovatelné úložiště uživatelů.
