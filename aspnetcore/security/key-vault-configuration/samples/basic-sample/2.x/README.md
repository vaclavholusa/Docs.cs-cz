# <a name="key-vault-configuration-provider-sample-application-aspnet-core-2x"></a>Zprostředkovatel konfigurace trezoru klíčů ukázkovou aplikaci (ASP.NET Core 2.x)

Tento příklad ukazuje použití zprostředkovatele služby Azure Key Vault konfigurace pro ASP.NET Core 2.x. Ukázka 1.x ASP.NET Core, najdete v části [zprostředkovatele konfigurace trezoru klíčů ukázkovou aplikaci (ASP.NET Core 1.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/key-vault-configuration/samples/basic-sample/1.x).
