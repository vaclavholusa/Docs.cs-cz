# <a name="prefix-key-vault-configuration-provider-sample-application-aspnet-core-2x"></a>Předpona zprostředkovatel konfigurace trezoru klíčů ukázkovou aplikaci (ASP.NET Core 2.x)
