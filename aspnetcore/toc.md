...
## [Statické soubory](fundamentals/static-files.md)
## [Směrování](fundamentals/routing.md)
## [Middleware pro přepis adres URL](fundamentals/url-rewriting.md)
## [Používání více prostředí](fundamentals/environments.md)
...
## [Směrování a aplikační konvence](xref:mvc/razor-pages/razor-pages-conventions)
