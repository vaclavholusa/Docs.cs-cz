...
<span data-ttu-id="d7cea-104">[Předchozí – přidání pole](new-field.md)
[další – zkontrolujte podrobnosti a odstraňte metody](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="d7cea-104">[Previous - Add a field](new-field.md)
