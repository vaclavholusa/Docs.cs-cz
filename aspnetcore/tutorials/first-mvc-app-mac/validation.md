...
<span data-ttu-id="30427-103">[Předchozí – přidání pole](new-field.md)
[další – zkontrolujte podrobnosti a odstraňte metody](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="30427-103">[Previous - Add a field](new-field.md)
