...
<span data-ttu-id="f62cb-103">[Předchozí - přidat vyhledávání](search.md)
[další – přidání ověřování](validation.md)</span><span class="sxs-lookup"><span data-stu-id="f62cb-103">[Previous - Add search](search.md)
