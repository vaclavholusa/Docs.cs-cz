...
<span data-ttu-id="beada-104">[Předchozí - přidat vyhledávání](search.md)
[další – přidání ověřování](validation.md)</span><span class="sxs-lookup"><span data-stu-id="beada-104">[Previous - Add search](search.md)
