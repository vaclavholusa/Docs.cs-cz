...
ms.locfileid: "30898419"
---
[!INCLUDE [adding-field](../../includes/mvc-intro/new-field.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="b761a-103">[Předchozí - přidat vyhledávání](search.md)
> [další – přidání ověřování](validation.md)</span><span class="sxs-lookup"><span data-stu-id="b761a-103">[Previous - Add search](search.md)
