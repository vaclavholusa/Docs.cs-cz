...
ms.locfileid: "36961331"
---
[!INCLUDE [adding-field](../../includes/mvc-intro/new-field.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="6790d-103">[Předchozí - přidat vyhledávání](search.md)
> [další – přidání ověřování](validation.md)</span><span class="sxs-lookup"><span data-stu-id="6790d-103">[Previous - Add search](search.md)
