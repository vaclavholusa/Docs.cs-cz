...
keywords: ASP.NET Core, EF migrace
ms.author: riande
manager: wpickett
ms.date: 04/14/2017
...
<span data-ttu-id="c9509-104">[Předchozí - přidat vyhledávání](search.md)
[další – přidání ověřování](validation.md)</span><span class="sxs-lookup"><span data-stu-id="c9509-104">[Previous - Add search](search.md)
