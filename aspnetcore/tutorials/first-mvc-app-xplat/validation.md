...
ms.locfileid: "36961136"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="eed2f-103">[Předchozí – přidání pole](new-field.md)
> [další – zkontrolujte podrobnosti a odstraňte metody](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="eed2f-103">[Previous - Add a field](new-field.md)
