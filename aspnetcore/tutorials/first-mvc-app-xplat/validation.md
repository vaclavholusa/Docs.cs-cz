...
ms.locfileid: "30897143"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="3b78d-103">[Předchozí – přidání pole](new-field.md)
> [další – zkontrolujte podrobnosti a odstraňte metody](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="3b78d-103">[Previous - Add a field](new-field.md)
