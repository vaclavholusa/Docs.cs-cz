...
keywords: "ASP.NET Core, ověření, DataAnnotations"
ms.author: riande
manager: wpickett
ms.date: 04/13/2017
...
<span data-ttu-id="3565d-104">[Předchozí – přidání pole](new-field.md)
[další – zkontrolujte podrobnosti a odstraňte metody](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="3565d-104">[Previous - Add a field](new-field.md)
