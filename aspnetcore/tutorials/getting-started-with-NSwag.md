...
* Uložte soubor do projektu klienta (například [Xamarin.Forms](https://developer.xamarin.com/guides/xamarin-forms/) aplikace). Začněte spotřebovávat rozhraní API:
