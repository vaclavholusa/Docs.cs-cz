...
## <a name="building-web-applications"></a>Vytváření webové aplikace
...
## <a name="building-web-apis"></a>Vytváření webových rozhraní API
...
* [Základní webové rozhraní API pomůže stránky ASP.NET pomocí Swagger](web-api-help-pages-using-swagger.md)
* [Vytváření back-end webové služby pro nativní mobilní aplikace](../mobile/native-mobile-backend.md)
...
* [Povolení ověřování pomocí služby Facebook, Google a dalších externích zprostředkovatelů](../security/authentication/social/index.md)
* [Potvrzení účtu a heslo pro obnovení](../security/authentication/accconfirm.md)
* [Dvoufaktorové ověřování pomocí serveru SMS](../security/authentication/2fa.md)

## <a name="client-side-development"></a>Vývoj pro klienta
* [Pomocí Gulp](../client-side/using-gulp.md)
* [Pomocí Grunt](../client-side/using-grunt.md)
* [Spravovat balíčky klienta s Bower](../client-side/bower.md)
* [Vytváření Krásný přizpůsobivý weby s Bootstrap](../client-side/bootstrap.md)

## <a name="testing"></a>Testování
* [Testování částí v .NET Core pomocí testu dotnet.](https://docs.microsoft.com/dotnet/articles/core/testing/unit-testing-with-dotnet-test)

## <a name="publishing-and-deployment"></a>Publikování a nasazení
...
* [Publikování webové aplikace Azure s průběžné nasazování.](../publishing/azure-continuous-deployment.md)
