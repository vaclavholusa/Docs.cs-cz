...
> <span data-ttu-id="57fa9-103">[Předchozí: Přidání model](xref:tutorials/razor-pages-mac/model)
> [Další: aktualizace stránky](xref:tutorials/razor-pages-mac/da1)</span><span class="sxs-lookup"><span data-stu-id="57fa9-103">[Previous: Adding a model](xref:tutorials/razor-pages-mac/model)
