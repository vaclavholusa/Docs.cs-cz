...
====================
<span data-ttu-id="67cab-104">podle [Stagner Jan](https://github.com/JoeStagner)</span><span class="sxs-lookup"><span data-stu-id="67cab-104">by [Joe Stagner](https://github.com/JoeStagner)</span></span>

<span data-ttu-id="67cab-105">Toto video ukazuje, jak rychle a snadno může být začít vyvíjet distribuované aplikace založené na protokolu SOAP nebo webové služby XML.</span><span class="sxs-lookup"><span data-stu-id="67cab-105">This video shows you how quick and easy it can be to start developing distributed applications based on SOAP / XML web services.</span></span>

[<span data-ttu-id="67cab-106">&#9654; Podívejte se na video (26 minut)</span><span class="sxs-lookup"><span data-stu-id="67cab-106">&#9654; Watch video (26 minutes)</span></span>](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/an-introduction-to-soap-based-web-services-with-visual-web-developer-2008)
