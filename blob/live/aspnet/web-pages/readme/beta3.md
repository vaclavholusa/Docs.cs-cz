...
> <span data-ttu-id="68afd-127">V tématu [podrobné pokyny k publikování aplikací](https://go.microsoft.com/fwlink/?LinkID=196149)</span><span class="sxs-lookup"><span data-stu-id="68afd-127">See [Step-by-Step Instructions for Publishing Applications](https://go.microsoft.com/fwlink/?LinkID=196149)</span></span>
...
#### <a name="issue-encrypt-property-is-not-recognized"></a><span data-ttu-id="68afd-303">Problém: Vlastnost "Šifrovat" nebyl rozpoznán.</span><span class="sxs-lookup"><span data-stu-id="68afd-303">Issue: "Encrypt" property is not recognized</span></span>
...
> <span data-ttu-id="68afd-326">Odinstalujte SQL Server Compact 4.0 CTP1.</span><span class="sxs-lookup"><span data-stu-id="68afd-326">Uninstall SQL Server Compact 4.0 CTP1.</span></span> <span data-ttu-id="68afd-327">Stáhněte a nainstalujte plné verze rozhraní .NET Framework z následujícího umístění:</span><span class="sxs-lookup"><span data-stu-id="68afd-327">Download and install the full versions of the .NET Framework from the following location:</span></span>
> 
...
> <span data-ttu-id="68afd-385">Google Chrome se nezobrazuje v seznamu prohlížečů v části **spustit** na **Domů** kartě.</span><span class="sxs-lookup"><span data-stu-id="68afd-385">Google Chrome is not displayed in the list of browsers under **Run** on the **Home** tab.</span></span>
> 
...
> <span data-ttu-id="68afd-392">To je úmyslné.</span><span class="sxs-lookup"><span data-stu-id="68afd-392">This is intentional.</span></span> <span data-ttu-id="68afd-393">Není nutné k zadání názvu primární klíč tabulky primárního klíče.</span><span class="sxs-lookup"><span data-stu-id="68afd-393">You do not need to enter the name of the primary key from the primary key table.</span></span>


#### <a name="issue-the-relationships-button-is-disabled"></a><span data-ttu-id="68afd-394">Problém: Tlačítko "Vztahů" zakázána.</span><span class="sxs-lookup"><span data-stu-id="68afd-394">Issue: The "Relationships" button is disabled</span></span>

> <span data-ttu-id="68afd-395">**Vztahy** tlačítko pod **tabulky** ve **databáze** pracovního prostoru je zakázán pro systém SQL Server Compact databáze.</span><span class="sxs-lookup"><span data-stu-id="68afd-395">The **Relationships** button under the **Table** tab in the **Databases** workspace is disabled for SQL Server Compact databases.</span></span>
> 
> <span data-ttu-id="68afd-396">**Alternativní řešení**</span><span class="sxs-lookup"><span data-stu-id="68afd-396">**Workaround**</span></span>  
> <span data-ttu-id="68afd-397">Žádné</span><span class="sxs-lookup"><span data-stu-id="68afd-397">None.</span></span> <span data-ttu-id="68afd-398">Systém SQL Server Compact nepodporuje relace mezi tabulkami.</span><span class="sxs-lookup"><span data-stu-id="68afd-398">SQL Server Compact does not support relationships between tables.</span></span>


#### <a name="issue-parameterized-sql-queries-throw-exceptions"></a><span data-ttu-id="68afd-399">Problém: SQL parametrizované dotazy generování výjimek</span><span class="sxs-lookup"><span data-stu-id="68afd-399">Issue: Parameterized SQL queries throw exceptions</span></span>

> <span data-ttu-id="68afd-400">V systému SQL Server Compact 4.0, pokud nezadáte, jako datový typ `SqlDbType` nebo `DbType` pro parametry v parametrizované dotazy, je vyvolána výjimka při spuštění dotazu.</span><span class="sxs-lookup"><span data-stu-id="68afd-400">In SQL Server Compact 4.0, if you do not specify a data type such as `SqlDbType` or `DbType` for parameters in parameterized queries, an exception is thrown when the query runs.</span></span>
> 
> <span data-ttu-id="68afd-401">**Alternativní řešení**</span><span class="sxs-lookup"><span data-stu-id="68afd-401">**Workaround**</span></span>  
> <span data-ttu-id="68afd-402">Explicitně nastavit na datový typ pro parametry, jako `SqlDbType` nebo `DbType`.</span><span class="sxs-lookup"><span data-stu-id="68afd-402">Explicitly set the data type for parameters such as `SqlDbType` or `DbType`.</span></span> <span data-ttu-id="68afd-403">Je to nezbytné v případě datové typy objektů BLOB (`image` a `ntext`).</span><span class="sxs-lookup"><span data-stu-id="68afd-403">This is critical in the case of BLOB data types (`image` and `ntext`).</span></span> <span data-ttu-id="68afd-404">Použijte kód takto:</span><span class="sxs-lookup"><span data-stu-id="68afd-404">Use code like the following:</span></span>
> 
...
## <a name="for-more-information"></a><span data-ttu-id="68afd-405">Další informace</span><span class="sxs-lookup"><span data-stu-id="68afd-405">For More Information</span></span>

<span data-ttu-id="68afd-406">Další informace o službě WebMatrix Beta 3 najdete na následujících webech:</span><span class="sxs-lookup"><span data-stu-id="68afd-406">For more information about WebMatrix Beta 3, see the following websites:</span></span>

- [<span data-ttu-id="68afd-407">IIS.net</span><span class="sxs-lookup"><span data-stu-id="68afd-407">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="68afd-408">TECHNOLOGIE ASP.NET</span><span class="sxs-lookup"><span data-stu-id="68afd-408">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="68afd-409">Http://www.microsoft.com/web/gallery/install.aspx?appid=IISExpress</span><span class="sxs-lookup"><span data-stu-id="68afd-409">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

* * *

<span data-ttu-id="68afd-410">© 2010 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="68afd-410">© 2010 Microsoft Corporation.</span></span> <span data-ttu-id="68afd-411">Všechna práva vyhrazena.</span><span class="sxs-lookup"><span data-stu-id="68afd-411">All Rights Reserved.</span></span> <span data-ttu-id="68afd-412">[Podmínky použití](https://msdn.microsoft.com/en-us/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="68afd-412">[Terms of Use](https://msdn.microsoft.com/en-us/cc300389.aspx).</span></span>
